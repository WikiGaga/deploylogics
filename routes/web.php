...
// Route::post('/cheque-designer/save', [ChequeController::class, 'saveLayout'])->name('cheque.layout.save');

// Route::get('/cheque-print/{layout}', [ChequeController::class, 'printForm'])->name('cheque.print.form');
// Route::post('/cheque-print/{layout}', [ChequeController::class, 'printCheque'])->name('cheque.print');
...
//==================inventory=========================
        ...
        Route::prefix('languages')->group(function () {
            Route::post('change/{id?}','Languages\LanguageTranslationController@changeLanguage')->name('change.language');
...
//==================Dashboard Studio=========================
        ...
        Route::prefix('notification-settings')->group(function () {
            ...
            Route::delete('delete/{id}','Development\NotificationSettingsController@destroy');
        });
        ...
        Route::prefix('common')->group(function () {
            ...
            // Favorites routes
            Route::get('favorites', 'Common\FavoriteController@getFavorites');
            Route::get('favorites/{id}/items', 'Common\FavoriteController@getFavoriteItems');
            Route::post('favorites', 'Common\FavoriteController@saveFavorite');
            Route::put('favorites/{id}', 'Common\FavoriteController@updateFavorite');
            Route::delete('favorites/{id}', 'Common\FavoriteController@deleteFavorite');
            Route::get('get-product-barcode/{id}', 'Common\FavoriteController@getProductBarcode');
...
Route::post('/cheque/template/store', [ChequeController::class, 'store']);


Route::post('/cheque/template/save-layout', [ChequeController::class, 'saveLayout']);
Route::get('/cheque/template/design/{id}', [ChequeController::class, 'design']);
Route::get('/cheque/print-form/{id}', [ChequeController::class, 'printForm']);
// Route::post('/cheque/print/{id}', [ChequeController::class, 'printCheque']);
Route::post('/cheque/print', [ChequeController::class, 'printCheque'])->name('cheque.print');
