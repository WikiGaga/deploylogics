        ...
        $('#kt_calendar_external_events .fc-draggable-handle').each(function() {
            ...
            $(this).data('event', {
             ...
             /*   start: YM + '-02',
                ...
                description: '1 Lorem ipsum dolor eius mod tempor labore'
            });
        });
    }
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            events: [
                ...
                },
                {
                    ...
                    start: YM + '-03',
                    description: '1st Half = 6:00am to 10:00am\n' +
                        'break = 10:00am to 11:00am',
                    end: YM + '-08',
            ...
            drop:  function (arg) {
                ...
                console.log(arg.draggedEl.getAttribute('event-id'));*/
            ...
            eventDrop:function( eventDropInfo ) {
              ...
              //  console.log(eventDropInfo.event.start.toISOString());
                ...
                // {{  when event drop to another date call ajax  }}
            ...
            eventRender: function(info) {
                ...
                if (info.event.extendedProps && info.event.extendedProps.description) {
                    ...
                    // calendar.addEvents(info.event.extendedProps)
                }
