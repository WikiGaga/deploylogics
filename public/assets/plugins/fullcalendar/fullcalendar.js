            ...
            p = function (t) {
                ...
                return r.__extends(e, t), e.prototype.addChild = function (t) {
                    ...
                    return o.isPlainObject(t) ? (i = t.date, r = t.type, s = t.forceOff) : i = t, i = l.default(i), u = {
                        ...
                        type: r || "day"
                    }, "string" == typeof e && (n = e, e = null), e = e ? " " + a.attrsToStr(e) : "", n = n || "", !s && this.opt("navLinks") ? "<a" + e + ' custom-week="'+r+'" data-goto="' + a.htmlEscape(JSON.stringify(u)) + '">' + n + "</a>" : "<span" + e + ">" + n + "</span>"
                ...
                return t.prototype.setToolbarOptions = function (t) {
                    ...
                    return u && i.each(u.split(" "), function (t, s) {
                        ...
                        i.each(s.split(","), function (t, s) {
                            ...
                            "title" === s ? (h = h.add(i("<h4>&nbsp;</h4>")), f = !1) : ((l = d[s]) ? (g = function (t) {
                    ...
                    this.el && this.el.find("h4").text(t)
