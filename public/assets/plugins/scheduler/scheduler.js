    ...
    ([
                ...
                */
                ...
                TimelineView.prototype.renderSlatHtml = function () {
                    ...
                    var rowUnits = formats.map(function (format) {
                        return (fullcalendar_1.queryMostGranularFormatUnit(format));
                    });
            ...
            var TimelineEventRenderer = /** @class */ (function (_super) {
                ...
                */
                ...
                TimelineEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
                    //console.log(seg);
                    var shiftID = seg.footprint.eventDef.id;
                    var resourceID = seg.footprint.eventDef.resourceIds["0"];
                    var eventDef = seg.footprint.eventDef;
                    var InternalData = seg.footprint.eventDef.miscProps;
                    //console.log("events ===> ",InternalData);
                    ...
                    if (InternalData.Type == "Holiday") {
                        return '<a data-event-type="' + InternalData.Type + '" class="1234 tooltip ' + classes.join(' ') + ' emp_' + resourceID + '" id="shift_' + shiftID + '" data-tooltip-content="#tooltip_content" style="' + fullcalendar_1.cssToStr(this.getSkinCss(seg.footprint.eventDef)) + '"' +
                            (eventDef.url ?
                            ...
                            '<span class="fc-time">' +
                            InternalData.holiday_category + ' - ' + InternalData.pay_type +
                            '</span>' +
                            (timeText ?
                                '<div class="fc-time">' +
            ...
            */
            var ResourceDayTableMixin = /** @class */ (function (_super) {
                ...
                ResourceDayTableMixin.prototype.flattenResources = function (resources) {
                    ...
                    if (orderVal) {
                        ...
                        sortFunc = function (a, b) {
                            return fullcalendar_1.compareByFieldSpecs(a, b, orderSpecs_1);
                        };
                    } else {
                        sortFunc = null;
                    }
                ...
                ResourceDayTableMixin.prototype.renderHeadResourceHtml = function () {
                    var _this = this;
                    var resourceHtmls = this.flattenedResources.map(function (resource) {
                        return (_this.renderHeadResourceCellHtml(resource));
                    });
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var ResourceTimelineView = /** @class */ (function (_super) {
                ...
                ResourceTimelineView.prototype.prepareHits = function () {
                    ...
                    var trArray = shownEventRows.map(function (row) {
                        return (row.getTr('event')[0]);
                    });
                ...
                ResourceTimelineView.prototype.getEventRows = function () {
                    return this.rowHierarchy.getRows().filter(function (row) {
                        return (row instanceof EventRow_1.default);
                    });
                };
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var EventRow = /** @class */ (function (_super) {
                ...
                EventRow.prototype.renderEventSkeleton = function (tr) {
                    var theme = this.view.calendar.theme;
                    tr.html("<td class=\"" + theme.getClass('widgetContent') + "\"> <div class=\"hoverAdd\"> <div class=\"fc-event-container\" /> </div> </td>");
            ...
            var Spreadsheet = /** @class */ (function () {
                function Spreadsheet(view) {
                    ...
                    this.givenColWidths = this.colWidths =
                        this.view.colSpecs.map(function (colSpec) {
                ...
                Spreadsheet.prototype.renderSkeleton = function () {
                    ...
                    this.bodyScroller = new ClippedScroller_1.default({
                ...
                Spreadsheet.prototype.applyColWidths = function () {
                    ...
                    var defaultCssWidth = anyPercentages && !this.view.isHGrouping ?
                        'auto' :
                        '';
                    var cssWidths = colWidths.map(function (colWidth) {
                        return (colWidth != null ? colWidth : defaultCssWidth);
                    });
                    // if allNumbers
                    //    cssWidths.pop()
                    //    cssWidths.push('auto')
                ...
                Spreadsheet.prototype.queryColWidths = function () {
                    return this.headCellEls.map(function (i, node) {
            ...
            */
            var ResourceRow = /** @class */ (function (_super) {
                ...
                ResourceRow.prototype.renderEventSkeleton = function (tr) {
                    //console.log('in renderEventSkeleton() ');
                    _super.prototype.renderEventSkeleton.call(this, tr);
                    //console.log('this.resource.id : ',this.resource.id);
                ...
                */
                ResourceRow.prototype.renderSpreadsheetSkeleton = function (tr) {
                    //console.log('in renderSpreadsheetSkeleton()');

                    var theme = this.view.calendar.theme;
                    var resource = this.resource;

                    //console.log('this.view.colSpecs : ',this.view.colSpecs);
                    //console.log('_a.length : ',_a.length);
                    ...
                    for (var _i = 0, _a = this.view.colSpecs; _i < _a.length; _i++) {
                        ...
                        var contentEl = $('<div class="fc-cell-content">' +
                            ...
                            '</div> ' +
                            // '<div class="employeeTotalHours">Max Hours: ' +  + ' </div > ' +
                            '<div class="employeeTotalHours"></div > ' +
                            '</span> ' +
                            '</div>');
                        ...
                        //console.log('td class : ',theme.getClass('widgetContent'));
                    ...
                    //tr.attr('imran-resource-id', resource.id);
            ...
            var ResourceManager = /** @class */ (function (_super) {
                ...
                */
                    ...
                    switch ($.type(source)) {
                        ...
                        case 'object':
                            ...
                            $.ajax( // TODO: handle failure
                                $.extend({
                                    data: requestParams
                                }, ResourceManager.ajaxDefaults, source)).then(function (resourceInputs) {
                                calendar.popLoading();
                                callback(resourceInputs);
                            });
                            break;
                ...
                ResourceManager.prototype.setResources = function (resourceInputs) {
                    ...
                    var resources = resourceInputs.map(function (resourceInput) {
                        return (_this.buildResource(resourceInput));
                    });
                    var validResources = [];
                    for (var _i = 0, resources_1 = resources; _i < resources_1.length; _i++) {
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var UPGRADE_WINDOW = {
                years: 1,
                weeks: 1
            }; // 1 week leeway, for tz shift reasons too
        ...
        (function (module, exports, __webpack_require__) {
            ...
            fullcalendar_1.EventRenderer.prototype.beforeFgSegHtml = function (seg) {
                //console.log("in beforeFgSegHtml()");
