...
function addData(){
    $('#addData').click(function(){
        ...
        $('#repeated_data').append('<tr>' +
            ...
            '<td><input type="text" name="pd['+total_length+']['+id_04+']" value="'+val_04+'" title="'+val_04+'" class="uom_name form-control erp-form-control-sm" readonly></td>' +
            '<td><input type="text" name="pd['+total_length+']['+id_05+']" value="'+val_05+'" title="'+val_05+'" class="packing_name form-control erp-form-control-sm" readonly></td>' +
            '<td><input type="text" name="pd['+total_length+']['+id_06+']" value="'+val_06+'" title="'+val_06+'" class="tblGridCal_qty moveIndex form-control erp-form-control-sm validNumber validOnlyNumber" ></td>' +
