...
var KTFormWidgets = function () {
    // Private functions
    var validator;
    var formId = $( "#shift_sessions_form" )
        ...
        validator = formId.validate({
            ...
            submitHandler: function (form) {
                ...
                if (stagingFlowId && stagingFlowId.value) {
                    ...
                    if (!actionId && form.getAttribute('data-staging-last-action-id')) {
                        actionId = form.getAttribute('data-staging-last-action-id');
                    }
                    if (!actionCode && form.getAttribute('data-staging-last-action-code')) {
                        actionCode = form.getAttribute('data-staging-last-action-code');
                    }
                    ...
                    } else if (stagingActionCode && stagingActionCode.value) {
                        formData.set('staging_action_code', stagingActionCode.value);
                    }
