...
$(document).ready(function(){
   /* shortcuts.add(dataSession.saveBtn,function(e) {
        // e.preventDefault();
        $('button[type="submit"]').click();
        return false;
    });
    shortcuts.add(dataSession.createBtn,function(e) {
        // e.preventDefault();
        document.getElementById('btn-create').click();
        return false;
    });
    shortcuts.add(dataSession.backBtn,function(e) {
        // e.preventDefault();
        document.getElementById('btn-back').click();
        return false;
    });
    shortcuts.add('+',function(e) {
        // e.preventDefault();
        document.getElementById('addData').click();
        return false;
    });
    shortcuts.add('ctrl+alt+p',function(e) {
        // e.preventDefault();
        var data_url = '/common/get-product-detail/get-product/';
    ...
    $(document).on('keyup',function(e){
        var plus = [107,187]
        if(plus.includes(e.keyCode) || plus.includes(e.which)){
            if(document.getElementById('product_barcode_id').value != ""){
                document.getElementById('addData').click();
            }
        }
        return false;
