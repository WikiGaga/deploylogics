...
function addData(){
    $('#addData').click(function(){
        ...
        $('#repeated_data').append('<tr>' +
            '<td><input type="text" value="'+total_length+'" name="pd['+total_length+']['+id_01+']"  class="form-control erp-form-control-sm" readonly></td>' +
            '<td><input type="text" name="pd['+total_length+']['+id_02+']" value="'+val_02+'" class="moveIndex form-control erp-form-control-sm" ></td>' +
            '<td><input type="text" name="pd['+total_length+']['+id_03+']" value="'+val_03+'" class="form-control erp-form-control-sm" readonly></td>' +
            '<td><input type="text" name="pd['+total_length+']['+id_04+']" value="'+val_04+'" class="form-control erp-form-control-sm" readonly></td>' +
            '<td><input type="text" name="pd['+total_length+']['+id_05+']" value="'+val_05+'" class="form-control erp-form-control-sm" readonly></td>' +
            '<td><input type="text" name="pd['+total_length+']['+id_06+']" value="'+val_06+'" class="moveIndex form-control erp-form-control-sm" ></td>' +
            '<td><input type="text" name="pd['+total_length+']['+id_07+']" value="'+val_07+'" class="form-control erp-form-control-sm" readonly></td>' +
            '<td><input type="text" name="pd['+total_length+']['+id_08+']" value="'+val_08+'" class="form-control erp-form-control-sm" readonly></td>' +
            '<td><input type="text" name="pd['+total_length+']['+id_09+']" value="'+val_09+'" class="moveIndex form-control erp-form-control-sm" ></td>' +
            '<td><input type="text" name="pd['+total_length+']['+id_10+']" value="'+val_10+'" class="form-control erp-form-control-sm" readonly></td>' +
            '<td><input type="text" name="pd['+total_length+']['+id_11+']" value="'+val_11+'" class="moveIndex form-control erp-form-control-sm" ></td>' +
            '<td><input type="text" name="pd['+total_length+']['+id_12+']" value="'+val_12+'" class="form-control erp-form-control-sm" readonly></td>' +
            '<td><input type="text" name="pd['+total_length+']['+id_13+']" value="'+val_13+'" class="moveIndex form-control erp-form-control-sm" ></td>' +
            '<td><input type="text" name="pd['+total_length+']['+id_14+']" value="'+val_14+'" class="form-control erp-form-control-sm" readonly></td>' +
            '<td><input type="text" name="pd['+total_length+']['+id_15+']" value="'+val_15+'" class="form-control erp-form-control-sm" readonly></td>' +
            '<td class="text-center"><div class="btn-group btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-success gridBtn editData"><i class="la la-pencil"></i></button><button type="button" class="btn btn-danger gridBtn delData"><i class="la la-trash"></i></button></div></td>' +
            '</tr>');
        formClear();
        dataDelete();
        dataEdit();
