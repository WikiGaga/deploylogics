...
class SalesQuotationController extends Controller
{
    ...
    public static $page_title = 'Sales Quotation';
    public static $redirect_url = 'sales-quotation';
    public static $menu_dtl_id = '198';
    public static $type = 'sq';
    /**
    ...
    public function create($id = null)
    {
        ...
        return view('sales.sales_quotation.form',compact('data'));
    }
    ...
    public function print($id,$type = null)
    {
        ...
        if(isset($type) && $type=='pdf'){
            $view = view('prints.sales_quotation_print', compact('data'))->render();
            //dd($view);
            $dompdf = new Dompdf();
            ...
            return view('prints.sales_quotation_print',compact('data'));
        }
    }
