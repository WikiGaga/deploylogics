...
class VoucherCashPosting extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'voucher:cash_posting';
    ...
    public function handle()
    {
        ...
        $yesterday_date = $yesterday->format("d-m-Y");
        $today_format = date('d-m-Y', strtotime($yesterday_date));
