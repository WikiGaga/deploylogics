...
@section('title', 'Insert Slow Moving Stock')
...
@section('content')
    ...
    <!--begin::Form-->
    <form id="slow_moving_items_form" class="kt-form" method="post" action="{{ action('Inventory\InsertSlowMovingItemsController@store', [isset($id)?$id:'']) }}">
    @csrf
                            ...
                            <div class="row form-group-block">
                                ...
                                <div class="col-lg-9">
                                    <div class="erp-select2">
                                        <select class="form-control kt-select2 erp-form-control-sm" multiple id="branch_ids" name="branch_ids[]">
...
@section('customJS')
    <script src="{{ asset('js/pages/js/insert-slow-moving-items.js') }}" type="text/javascript"></script>
    <script>
        var arrows = {
