...
@section('content')
    ...
    <form id="change_group_form" class="kt-form" method="post" action="{{ action('Inventory\StockController@changeProductGroup') }}">
        <input type="hidden" value='change_product_group' id="form_type">
        @csrf
