...
@section('title', 'Internal Stock Transfer')
...
@section('content')
    ...
    <form id="internal_stock_transfer_form" class="stock_form kt-form" method="post" action="{{ action('Inventory\StockController@store', [$type,$id]) }}">
    @csrf
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <div class="row form-group-block">
                    ...
                    <div class="col-lg-4">
                        <div class="row">
                            <label class="col-lg-4 erp-col-form-label">From Store:<span class="required">*</span></label>
                            <div class="col-lg-8">
                    ...
                    <div class="col-lg-4">
                        <div class="row">
                            <label class="col-lg-4 erp-col-form-label">To Store:<span class="required">*</span></label>
                            <div class="col-lg-8">
                                <div class="erp-select2">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="row">
                            <label class="col-lg-4 erp-col-form-label">Supplier:</label>
                            <div class="col-lg-8">
                            ...
                            <div class="dropdown dropdown-inline">
                                ...
                                @php
                                    $headings = ['Sr No','Barcode','Product Name','UOM','Packing','Qty',
                                                  'Sale Rate','Purc Rate','Batch No','Amount'];
                                @endphp
                            ...
                            <table class="table erp_form__grid erp_form__grid_th_resize table-resizable dtr-inline">
                                ...
                                <tr>
                                    ...
                                    <th scope="col">
                                        ...
                                        <div class="erp_form__grid_th_input">
                                            <input id="rate" readonly type="text" class="tblGridCal_rate validNumber form-control erp-form-control-sm">
                                        </div>
                                    </th>
                                    <th scope="col">
                                    ...
                                    <th scope="col">
                                        ...
                                        <div class="erp_form__grid_th_input">
                                            <input id="expiry_date" value="{{date('d-m-Y')}}" title="{{date('d-m-Y')}}" type="text" class="date_inputmask tb_moveIndex form-control erp-form-control-sm">
                                        </div>
                                    </th>
                                    <th scope="col">
                                ...
                                @if(isset($dtls))
                                    @foreach($dtls as $dtl)
                                        <tr>
                                            ...
                                            <td><input type="text" data-id="rate" readonly name="pd[{{$loop->iteration}}][rate]" value="{{number_format($dtl->stock_dtl_rate,3)}}" class="tblGridCal_rate form-control erp-form-control-sm validNumber" ></td>
...
@section('customJS')
    ...
    <script>
        ...
        $(document).on("blur",".tblGridCal_purc_rate",function(){
            var thix = $(this);
            thix.val(parseFloat(thix.val()).toFixed(3))
        });
    </script>
