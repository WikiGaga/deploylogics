                        ...
                        <div class="table-scroll form_input__block">
                            <table class="table erp_form__grid erp_form__grid_th_resize table-resizable dtr-inline">
                                ...
                                <tr>
                                    ...
                                    <th scope="col">
                                        <div class="erp_form__grid_th_title">Consumption</div>
                                        <div class="erp_form__grid_th_input">
                                            <input id="pd_comsume_qty" type="text" class="pd_comsume_qty validNumber form-control erp-form-control-sm" readonly>
                                        </div>
                                    </th>
                                    <th scope="col">
                                        <div class="erp_form__grid_th_title">Demand Qty</div>
                                        <div class="erp_form__grid_th_input">
                                            <input id="pd_demand_qty" type="text" class="pd_demand_qty tblGridCal_qty stock_amount tb_moveIndex validNumber form-control erp-form-control-sm">
                                        </div>
                                    </th>
                                    <th scope="col">
...
@section('customJS')
    ...
    $('.physical_stock').keyup(function (e) {
       ...
       <script>
        ...
        var arr_text_Field = [
            ...
            {
                'id':'pd_comsume_qty',
                'fieldClass':'pd_comsume_qty validNumber',
                'readonly':true
            },
            {
                'id':'pd_demand_qty',
                'fieldClass':'pd_demand_qty tblGridCal_qty stock_amount tb_moveIndex validNumber'
            }
        ];
    ...
    <script src="{{ asset('js/pages/js/purchase/barcode-get-detail.js?v=1') }}" type="text/javascript"></script>
