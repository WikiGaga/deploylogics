...
@section('content')
    ...
    @php
            ...
            if($case == 'new'){
                ...
                $date =  date('d-m-Y');
                $id = '';
                if($data['stock_code_type'] == 'di'){
                    $selected_rate_type = 'item_cost_rate';
                }else{
    ...
    <form id="stock_item_form" class="stock_form kt-form" method="post" action="{{ action('Inventory\StockController@store', [$type,$id]) }}">
    @csrf
