...
@section('content')
    @php
        ...
        if($case == 'new'){}
        if($case == 'edit'){
            $id = $data['current']->ip_location_id;
            $name = $data['current']->ip_location_name;
            $address = $data['current']->ip_location_address;
            $status = $data['current']->ip_location_entry_status;
        }
    @endphp
    @permission($data['permission'])
    <form id="ip_address_form" class="master_form kt-form" method="post" action="{{ action('Setting\IPAddressController@store', isset($id)?$id:"") }}">
    @csrf
    <!-- begin:: Content -->
            ...
            <div class="kt-portlet kt-portlet--mobile">
                ...
                <div class="kt-portlet__body">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group-block row">
                            <label class="col-lg-3 erp-col-form-label">Address: <span class="required">*</span></label>
                            <div class="col-lg-6">
                                <input type="text" name="address" value="{{isset($address)?$address:""}}" class="form-control erp-form-control-sm medium_text">
                            </div>
                        </div>
                        <div class="form-group-block row">
