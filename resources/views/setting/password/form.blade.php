...
@section('content')
    ...
    <form id="password_form" class="kt-form" method="post" action="{{ action('Setting\PasswordController@store', isset($id)?$id:'') }}">
        @csrf
        <div class="col-lg-12">
            <div class="erp-card">
                    ...
                    <div class="kt-portlet">
                        <div class="kt-portlet__body" style="padding-top: 23px;">
                            <div class="form-group-block row">
                                <label class="col-lg-2 erp-col-form-label">Old Password: <span class="required">*</span></label>
                                <div class="col-lg-4">
                                    <input type="password" id="old_password" name="old_password" class="form-control erp-form-control-sm">
                                </div>
                            </div>
                            <div class="form-group-block row">
