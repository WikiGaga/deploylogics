...
@section('content')
    ...
    <form id="password_form" class="kt-form" method="post" action="{{ action('Setting\PasswordController@newChangestore') }}">
        @csrf
        <div class="col-lg-12">
            <div class="erp-card">
...
@section('customJS')
    <script src="{{ asset('js/pages/js/new-password-change.js') }}" type="text/javascript"></script>
@endsection
