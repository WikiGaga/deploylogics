...
@section('content')
    ...
    <form id="password_form" class="kt-form" method="post" action="{{ action('Setting\PasswordController@newPosChangestore') }}">
        @csrf
        <div class="col-lg-12">
            <div class="erp-card">
                    ...
                    <div class="kt-portlet">
                        <div class="kt-portlet__body" style="padding-top: 23px;">
                            <div class="form-group-block row">
                                <label class="col-lg-2 erp-col-form-label">User: <span class="required">*</span></label>
                                <div class="col-lg-4">
...
@section('customJS')
    <script src="{{ asset('js/pages/js/new-pos-password-change.js') }}" type="text/javascript"></script>
@endsection
