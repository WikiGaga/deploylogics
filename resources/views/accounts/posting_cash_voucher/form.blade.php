...
@section('title', 'Cash Voucher Posting')
...
@section('content')
    ...
    <!--begin::Form-->
    <form id="voucher_form" class="kt-form" method="post" action="{{ action('Accounts\PostingCashVoucherController@store', [isset($id)?$id:'']) }}">
    @csrf
