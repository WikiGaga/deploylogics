...
@section('title', 'Liability Voucher')
                                        ...
                                        <div class="col-lg-6">
                                            <div class="erp_form___block">
                                                <div class="input-group open-modal-group">
                                                    <input type="text" id="last_voucher_no" value="{{isset($data['last_voucher_no'])?$data['last_voucher_no']:""}}" data-url="{{action('Common\DataTableController@inlineHelpOpen','oLVVoucherHelp')}}" autocomplete="off" class="open_inline__help form-control erp-form-control-sm moveIndex" placeholder="Enter here">
                                    ...
                                    @if(isset($dtls))
                                        @foreach($dtls as $data)
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" name="pd[{{ $loop->iteration }}][account_code]" data-id="account_code" value="{{$data->accounts->chart_code}}" title="{{$data->accounts->chart_code}}" data-url="{{action('Common\DataTableController@inlineHelpOpen','accountsHelp')}}" class="acc_code open_inline__help tb_moveIndex form-control erp-form-control-sm" readonly></td>
