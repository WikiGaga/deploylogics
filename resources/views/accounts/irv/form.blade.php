...
@section('title', 'Internal Receive Voucher')
...
<!--begin::Form-->
<form id="voucher_form" class="kt-form" method="post" action="{{action('Accounts\VoucherController@irvstore', [$type,isset($id)?$id:''])}}">
    @csrf
