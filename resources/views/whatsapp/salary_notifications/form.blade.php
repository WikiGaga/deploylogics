...
<div class="kt-container kt-container--fluid kt-grid__item kt-grid__item--fluid">
    <div class="kt-portlet kt-portlet--mobile">
        ...
        <div class="kt-portlet__body">
            <form id="salary_notification_form" enctype="multipart/form-data" autocomplete="off">
                @csrf
                <div class="row mb-4">
            ...
            <div class="mb-4">
                ...
                <a href="{{ url('/listing/salary-notifications') }}" class="btn btn-secondary">Back to Listing</a>
            </div>
