...
@section('title', 'Sub Category Wise Profit')
            ...
            <div class="row row-block">
                <div class="col-lg-12">
                    @php
                        ...
                        //$where .= " and group_item_parent_id = ".$data['first_level'];
...
@section('customJS')
    <script>
        ...
        $(document).on('click','td',function(){
            ...
            var last_level = tr.attr('data-id');
            var validate = true;
            if(tbody.length == 1){
                ...
                if(validate && xhrGetData){
                    ...
                    xhrGetData = false;
                    var formData = {
                        report_case : 'product_wise_profit',
                        report_type: 'static',
                    ...
                    var url = "{{ action('Report\UserReportsController@staticStore', ['static','product_wise_profit','']) }}";
                    $.ajax({
                        headers: {
