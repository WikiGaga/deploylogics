...
@section('content')
    ...
    <div class="kt-portlet" id="kt_portlet_table">
        <div class="kt-portlet__head" >
            <div class="kt-invoice__brand">
                ...
                @if(count($data['branch_ids']) != 0)
                    @php $branch_lists = \Illuminate\Support\Facades\DB::table('tbl_soft_branch')->select('branch_id','branch_name')->whereIn('branch_id',$data['branch_ids'])->get(); @endphp
                    <h6 class="kt-invoice__criteria">
        ...
        @php
            ...
            $where .= " and v.business_id = ".auth()->user()->business_id." and v.branch_id = $branch_list->branch_id";
            // Correct way for a single ID
