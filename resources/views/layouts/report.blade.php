        ...
        orderDetails.forEach(function(item) {
            ...
            itemsHtml += `
                <tr>
                    ...
                    <td class="text-center align-middle text-danger" style="font-size: 0.95rem;">-${parseFloat(item.discount_on_food * item.quantity || 0).toFixed(3)} (${((((item.discount_on_food * item.quantity) / item.price) * 100) / item.quantity || 0).toFixed(0)}%)</td>
