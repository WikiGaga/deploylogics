...
<body>
    ...
    <div id="Top-Header">
        ...
        <a href="javascript:void(0)" target="_blanck" style="text-decoration: none;color:black;" title="Whatsapp"><i class="material-icons">whatsapp</i></a>
    ...
    <table class="tab footer-credit" style="margin-top: 15px">
        <tr>
