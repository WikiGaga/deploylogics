                ...
                <div class="col-md-10">
                    <div class="kt-radio-inline">
                        <label class="kt-radio kt-radio--bold kt-radio--warning mb-0">
                            ...
                            <input type="radio" id="default" name="po_types"{{$print_type==0?"checked":""}}> Default
                            <span></span>
                            </a>
                        </label>
                        <label class="kt-radio kt-radio--bold kt-radio--warning mb-0">
                            <a href="{{$data['print_link']}}?type=1">
                                <input type="radio" id="po" name="po_types"{{$print_type==1?"checked":""}}> Purchase Order
                                <span></span>
                            </a>
                        </label>
                        <label class="kt-radio kt-radio--bold kt-radio--warning mb-0">
                            <a href="{{$data['print_link']}}?type=2">
                                <input type="radio" id="poss" name="po_types" {{$print_type==2?"checked":""}}> Purchase Order Super Store
                                <span></span>
                            </a>
                        </label>
                        <label class="kt-radio kt-radio--bold kt-radio--warning mb-0">
                            <a href="{{$data['print_link']}}?type=3">
                                <input type="radio" id="pom" name="po_types" {{$print_type==3?"checked":""}}> Purchase Order With MRP
                                <span></span>
                            </a>
                        </label>
                        <label class="kt-radio kt-radio--bold kt-radio--warning mb-0">
                            <a href="{{$data['print_link']}}?type=4">
                                <input type="radio" id="expo" name="po_types" {{$print_type==4?"checked":""}}> Ex Purchase Order With Inventory
                                <span></span>
                            </a>
                        </label>
                        <label class="kt-radio kt-radio--bold kt-radio--warning mb-0">
                            <a href="{{$data['print_link']}}?type=5">
                                <input type="radio" id="spo" name="po_types"{{$print_type==5?"checked":""}}> Simple Purchase Order
                                <span></span>
                            </a>
                        </label>
                    </div>
        ...
        <table class="tableData">
            <tr>
                <td width="33.33%">
                    ...
                    <div>
                        <span class="heading heading-block">Vendor Name:</span>
                ...
                <td width="33.33%">
                    ...
                    <div>
                        ...
                        <span class="normal normal-block">{{auth()->user()->business->business_name}}</span>
                    </div>
                </td>
            </tr>
        </table>
