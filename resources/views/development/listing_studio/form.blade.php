...
@section('content')
    @php
        ...
        if($case == 'edit'){
            ...
            $reporting_dimension = isset($data['current']->listing_studio_dimension) ? $data['current']->listing_studio_dimension : [] ;
    ...
    <!--begin::Form-->
    <form id="listing_studio_form" class="erp_form_validation kt-form" method="post" action="{{ action('Development\ListingStudioController@store',isset($id)?$id:'') }}">
        @csrf
                        ...
                        <div class="kt-portlet__body">
                            <div class="row form-group-block">
                                <div class="col-lg-3">
                                    ...
                                    <input type="text" name="listing_studio_title" class="form-control erp-form-control-sm" value="{{isset($title)?$title:""}}"/>
                                </div>
                                <div class="col-lg-3">
                                    <label class="erp-col-form-label">Case Name:</label>
                                    @if($case == 'edit')
                                        <input type="hidden" name="listing_studio_case" value="{{ $case_name }}"/>
                                        <input type="text" class="form-control erp-form-control-sm" value="{{ $case_name }}" disabled/>
                                    @else
                                        <input type="text" name="listing_studio_case" class="form-control erp-form-control-sm"/>
                                    @endif
                                </div>
                                <div class="col-lg-3">
                                    <label class="erp-col-form-label">Select Table:</label>
                                    <div class="erp-select2 form-group">
                                        <select class="form-control kt-select2 erp-form-control-sm listing_studio_table_name" name="listing_studio_table_name">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="input-group date">
                                        <input type="text" name="listing_studio_date" class="form-control erp-form-control-sm c-date-p" readonly value="{{$date}}" id="kt_datepicker_3" />
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    ...
                                    <div class="erp-select2">
                                        <select class="form-control kt-select2 erp-form-control-sm listing_studio_view_type" name="listing_studio_view_type">
                                            <option value="business" {{ $listing_studio_view_type == 'business'?"selected":"" }}>Business</option>
                                            <option value="branch" {{ $listing_studio_view_type == 'branch'?"selected":"" }}>Branch</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    ...
                                    <div class="erp-select2">
                                        <select class="form-control kt-select2 erp-form-control-sm listing_studio_select_menu" name="listing_studio_select_menu">
                                            <option value="help" {{ $select_menu == 'help'?"selected":"" }}>Help</option>
                                            <option value="main_listing" {{ $select_menu == 'main_listing'?"selected":"" }}>Main Listing</option>
                                        </select>
                                    </div>
                                </div>
                                @if($case == 'edit' && $select_menu == 'main_listing')
                                    <div class="col-lg-3" id="listing_studio_select_menu_dtl_id" style="display: block">
                                        ...
                                        <div class="erp-select2">
                                            <select class="form-control kt-select2 erp-form-control-sm listing_studio_select_menu_dtl_id" name="listing_studio_select_menu_dtl_id">
                                                @foreach($data['MenuDtl'] as $MenuDtl)
                                                    <option value="{{$MenuDtl->menu_dtl_id}}" {{ $MenuDtl->menu_dtl_id == $menu_dtl_id?"selected":"" }}>{{$MenuDtl->menu_dtl_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-3" id="listing_studio_parent_menu" style="display: block">
                                        ...
                                        <div class="erp-select2">
                                            <select class="form-control kt-select2 erp-form-control-sm listing_studio_parent_menu" name="listing_studio_parent_menu">
                                                <option value="0">Select</option>
                                                <option value="accounts" {{ $parent_menu == 'accounts'?'selected':'' }}>Accounts</option>
                                                <option value="stock"  {{ $parent_menu == 'stock'?'selected':'' }}>Stock</option>
                                                <option value="day"  {{ $parent_menu == 'day'?'selected':'' }}>Day</option>
                                                <option value="barcode-labels"  {{ $parent_menu == 'barcode-labels'?'selected':'' }}>Barcode Labels</option>
                                            </select>
                                        </div>
                                    </div>
                                @else
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    ...
                                    <div class="form-group erp-select2 report-select2 column_name">
                                        ...
                                        @endphp
                                        <select class="form-control kt-select2 erp-form-control-sm listing_studio_dimension_column_name" multiple name="listing_studio_dimension_column_name[]">
                                            @if($case == 'edit')
                                                @php $col = []; @endphp
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="erp-select2 report-select2 column_title">
                                        <select class="form-control erp-form-control-sm listing_studio_dimension_column_title" multiple name="listing_studio_dimension_column_title[]">
                                            @if($case == 'edit')
                                                @php $col = []; @endphp
                                                @foreach($data['current']->listing_studio_dimension as $dimension)
                                    ...
                                    <div class="mt-1">
                                        ...
                                        <div class="mt-1">
                                            <label class="kt-checkbox kt-checkbox--success">
                                                ...
                                                <input type="checkbox" class="" value="desc" name="listing_studio_group_by" {{$group_by == 1?"checked":""}}>
                                                <span></span>
                                            </label>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-lg-9">
                                                    <div class="row">
                                                        <div class="col-lg-3">
                                                            ...
                                                            <div class="erp-select2">
                                                                <select class="form-control erp-form-control-sm listing_studio_user_filter_name" name="listing_studio_user_filter_name">
                                                                    <option value="0">Select</option>
                                                                    @foreach($allCols as $col_name)
                                                                        <option value="{{strtolower($col_name['column_name'])}}" {{ $user_filter['listing_studio_user_filter_name'] == strtolower($col_name['column_name'])?"selected":"" }}>{{strtolower($col_name['column_name'])}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            ...
                                                            <input type="text" value="{{$user_filter['listing_studio_user_filter_title']}}" class="form-control erp-form-control-sm listing_studio_user_filter_title" name="listing_studio_user_filter_title">
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <label class="erp-col-form-label">User Filter Type:</label>
                                                            <div class="erp-select2">
                                                                <select class="form-control erp-form-control-sm listing_studio_user_filter_type" name="listing_studio_user_filter_type">
                                                                    <option value="0">Select</option>
                                                                    <option value="boolean" {{ $user_filter['listing_studio_user_filter_type'] == 'boolean'?"selected":"" }}>Boolean</option>
                                                                    <option value="date" {{ $user_filter['listing_studio_user_filter_type'] == 'date'?"selected":"" }}>Date</option>
                                                                    <option value="number" {{ $user_filter['listing_studio_user_filter_type'] == 'number'?"selected":"" }}>Number</option>
                                                                    <option value="varchar2" {{ $user_filter['listing_studio_user_filter_type'] == 'varchar2'?"selected":"" }}>Varchar</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            ...
                                                            <div class="erp-select2">
                                                                <select class="form-control erp-form-control-sm listing_studio_user_case_name" name="listing_studio_user_case_name">
                                                                    <option value="0">Select</option>
                                                                    @foreach($data['filter_case_list'] as $case_list)
                                                                        <option value="{{$case_list->reporting_filter_case_id}}" {{ $user_filter['listing_studio_user_case_name'] == strtolower($case_list->reporting_filter_case_id)?"selected":"" }}>{{$case_list->reporting_filter_case_name}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-9">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <label class="erp-col-form-label">User Filter Title:</label>
                                                        <input type="text" class="form-control erp-form-control-sm listing_studio_user_filter_title" name="listing_studio_user_filter_title">
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <label class="erp-col-form-label">User Filter Type:</label>
                                                        <div class="erp-select2">
                                                    ...
                                                    <div class="col-lg-3">
                                                        ...
                                                        <div class="erp-select2">
                                                            <select class="form-control erp-form-control-sm listing_studio_user_case_name" name="listing_studio_user_case_name">
                                                                <option value="0">Select</option>
                                                                @foreach($data['filter_case_list'] as $case_list)
                                                                    <option value="{{$case_list->reporting_filter_case_id}}">{{$case_list->reporting_filter_case_name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                        ...
                        <div class="kt-portlet__body">
                            <div class="row">
                                <div class="col-lg-3">
                                    ...
                                    <div class="erp-select2">
                                        <select class="form-control kt-select2 erp-form-control-sm listing_studio_rows_per_page" name="listing_studio_rows_per_page">
                                            @php
                                                $per_page_rows_list = [10,20,25,50,100,200,250,500,1000,5000];
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="erp-select2 report-select2">
                                        <select class="form-control kt-select2 erp-form-control-sm listing_studio_sort_colum_name_1" name="listing_studio_sort_colum_name_1">
                                            @if($case == 'edit')
                                    ...
                                    <div class="mt-1">
                                        ...
                                        @if($case == 'edit')
                                            <label class="kt-radio kt-radio--success"> Ascending
                                                <input type="radio" class="" value="asc" name="listing_studio_sort_colum_name_value_1" {{$check_1 == "asc"?"checked":""}}>
                                                <span></span>
                                            </label>
                                        @else
                                            <label class="kt-radio kt-radio--success"> Ascending
                                                <input type="radio" class="" value="asc" name="listing_studio_sort_colum_name_value_1" checked>
                                                <span></span>
                                            </label>
                                        @endif
                                        <label class="kt-radio kt-radio--success"> Descending
                                            <input type="radio" class="" value="desc" name="listing_studio_sort_colum_name_value_1" {{$check_1 == "desc"?"checked":""}}>
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    ...
                                    <div class="erp-select2 report-select2">
                                        <select class="form-control kt-select2 erp-form-control-sm listing_studio_sort_colum_name_2" name="listing_studio_sort_colum_name_2">
                                            @if($case == 'edit')
                                                <option value="">Select</option>
                                                @foreach($allCols as $col_name)
                                    ...
                                    <div class="mt-1">
                                        ...
                                        @if($case == 'edit')
                                            <label class="kt-radio kt-radio--success"> Ascending
                                                <input type="radio" class="" value="asc" name="listing_studio_sort_colum_name_value_2"
                                                    {{$check_2 == "asc"?"checked":""}}>
                                                <span></span>
                                            </label>
                                        @else
                                            <label class="kt-radio kt-radio--success"> Ascending
                                                <input type="radio" class="" value="asc" name="listing_studio_sort_colum_name_value_2" checked>
                                                <span></span>
                                            </label>
                                        @endif
                                        <label class="kt-radio kt-radio--success"> Descending
                                            <input type="radio" class="" value="desc" name="listing_studio_sort_colum_name_value_2"
                                                                                    ...
                                                                                    <div class="col-lg-3">
                                                                                        ...
                                                                                        <div class="erp-select2 report-select2">
                                                                                            <select class="form-control erp-form-control-sm report_fields_name" name="listing_studio_default_filter_name">
                                                                                                <option value="0">Select</option>
                                                                                                @foreach($allCols as $col_name)
                                                                                                    <option value="{{strtolower($col_name['column_name'])}}" {{ $default_filter['listing_studio_default_filter_name'] == strtolower($col_name['column_name'])?"selected":"" }}>{{strtolower($col_name['column_name'])}}</option>
                                                                                                @endforeach
                                                                                            </select>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-lg-9">
                                                                                        <div class="row">
                                                                                            <div class="col-lg-4" id="report_filter_types">
                                                                                                ...
                                                                                                @php
                                                                                                    $datatype = \App\Models\TblSoftListingStudioDefaultFilter::where('listing_studio_default_filter_id', $default_filter['listing_studio_default_filter_id'])
                                                                                                                          ->where('listing_studio_default_filter_name', $default_filter['listing_studio_default_filter_name'])
                                                                                                                          ->first();
                                                                                                    $types = \App\Models\TblSoftFilterType::where('filter_type_data_type_name', $datatype->listing_studio_default_filter_field_type)->where('filter_type_entry_status',1)->get();
                                                                                                @endphp
                                                                                                ...
                                                                                                <div class="erp-select2 report-select2">
                                                                                                    <select class="form-control erp-form-control-sm report_condition" name="listing_studio_default_filter_condition">
                                                                                                        @foreach($types as $type)
                                                                                                            <option value="{{$type->filter_type_value}}" {{ ($type->filter_type_value == $default_filter['listing_studio_default_filter_condition'])?"selected":"" }}>{{$type->filter_type_title}}</option>
                                                                                                        @endforeach
                                                                                                    </select>
                                                                                                </div>
                                                                                            </div>
                                                                                            ...
                                                                                            <input type="hidden" id="report_value_column_type_name" name="listing_studio_default_filter_field_type" value="{{$datatype->listing_studio_default_filter_field_type}}"/>
                                                                                            <div class="col-lg-8" id="report_filter_block">
                                                                                                @if($datatype->listing_studio_default_filter_field_type == 'boolean')
                                                                                                    <div class="row" id="fields_values"  style="display: none">
                                                                                                        <div class="col-lg-12">
                                                                                                            ...
                                                                                                            <input disabled type="text" name="listing_studio_default_filter_value" class="report_value form-control erp-form-control-sm">
                                                                                                        </div>
                                                                                                    </div>
                                                                                                ...
                                                                                                @if($datatype->listing_studio_default_filter_field_type == 'varchar2')
                                                                                                    @if($default_filter['listing_studio_default_filter_condition'] == 'null' || $default_filter['listing_studio_default_filter_condition'] == 'not null')
                                                                                                        <div class="row" id="fields_values"  style="display: none">
                                                                                                                <div class="col-lg-12">
                                                                                                                    <label class="erp-col-form-label">Value:</label>
                                                                                                                    <input disabled type="text" name="listing_studio_default_filter_value" class="report_value form-control erp-form-control-sm">
                                                                                                    ...
                                                                                                    @else
                                                                                                        <div class="row" id="fields_values"  style="display: block">
                                                                                                            <div class="col-lg-12">
                                                                                                                <label class="erp-col-form-label">Value:</label>
                                                                                                                <input type="text" value="{{ $default_filter['listing_studio_default_filter_value'] }}" name="listing_studio_default_filter_value" class="report_value form-control erp-form-control-sm">
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div class="row" id="number_between"  style="display: none">
                                                                                                            <div class="col-lg-12">
                                                                                                        ...
                                                                                                        <div class="row" id="number_between"  style="display: block">
                                                                                                            <div class="col-lg-12">
                                                                                                                <div class="erp-row">
                                                                                                                    <div class="col-lg-6">
                                                                                                                        <label class="erp-col-form-label">From:</label>
                                                                                                                        <input type="text" value="{{ $default_filter['listing_studio_default_filter_value'] }}" name="listing_studio_default_filter_value" class="form-control erp-form-control-sm text-left validNumber">
                                                                                                                    </div>
                                                                                                                    <div class="col-lg-6">
                                                                                                                        <label class="erp-col-form-label">To:</label>
                                                                                                                        <input type="text" value="{{ $default_filter['listing_studio_default_filter_value_2'] }}" name="listing_studio_default_filter_value_2" class="form-control erp-form-control-sm text-left validNumber">
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                ...
                                                                                                @if($datatype->listing_studio_default_filter_field_type == 'date')
                                                                                                    <div class="row" id="date_between" style="display: block">
                                                                                                        <div class="col-lg-12">
                                                                                                            ...
                                                                                                            <div class="erp-selectDateRange">
                                                                                                                <div class="input-daterange input-group kt_datepicker_5">
                                                                                                                    <input type="text" value="{{ $default_filter['listing_studio_default_filter_value'] }}" class="form-control erp-form-control-sm" name="listing_studio_default_filter_value" />
                                                                                                                    <div class="input-group-append">
                                                                                                                        <span class="input-group-text erp-form-control-sm">To</span>
                                                                                                                    </div>
                                                                                                                    <input type="text" value="{{ $default_filter['listing_studio_default_filter_value_2'] }}" class="form-control erp-form-control-sm" name="listing_studio_default_filter_value_2" />
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <div class="row">
                                                                            ...
                                                                            <input type="hidden" id="report_value_column_type_name" name="listing_studio_default_filter_field_type"/>
                                                                            <div class="col-lg-8" id="report_filter_block">
                                        ...
                                        <div data-repeater-item class="metric_block">
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="erp-select2">
                                                        <select class="form-control erp-form-control-sm listing_studio_metric_column_name" name="listing_studio_metric_column_name">
                                                            <option value="0">Select</option>
                                                            @if($case == 'edit')
                                                                @foreach($allCols as $col_name)
                                                                    <option value="{{strtolower($col_name['column_name'])}}" {{ $metric_aggre['listing_studio_metric_column_name'] == strtolower($col_name['column_name'])?"selected":"" }}>{{strtolower($col_name['column_name'])}}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <input type="text" value="{{$metric_aggre['listing_studio_metric_column_title']}}" class="form-control erp-form-control-sm listing_studio_metric_column_title" name="listing_studio_metric_column_title">
                                                </div>
                                                <div class="col-lg-3">
                                                    <label class="erp-col-form-label">Aggregation:</label>
                                                    <div class="erp-select2">
                                                        <select class="form-control erp-form-control-sm listing_studio_metric_aggregation" name="listing_studio_metric_aggregation">
                                                            <option value="0">Select</option>
                                                            <option value="sum" {{$metric_aggre['listing_studio_metric_aggregation'] == 'sum'?'selected':''}}>Sum</option>
                                                            <option value="min" {{$metric_aggre['listing_studio_metric_aggregation'] == 'min'?'selected':''}}>Min</option>
                                                            <option value="max" {{$metric_aggre['listing_studio_metric_aggregation'] == 'max'?'selected':''}}>Max</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 text-right">
                                ...
                                @else
                                    <div data-repeater-item class="metric_block">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <label class="erp-col-form-label">Metric Field Title:</label>
                                                <input type="text" class="form-control erp-form-control-sm listing_studio_metric_column_title" name="listing_studio_metric_column_title">
                                            </div>
                                            <div class="col-lg-3">
                                                <label class="erp-col-form-label">Aggregation:</label>
                                                <div class="erp-select2">
                        ...
                        <div class="kt-portlet__body">
                            <div class="row">
                                <div class="col-lg-3">
                                    <label class="erp-col-form-label">Select Table:</label>
                                    <div class="erp-select2 form-group">
                                        <select class="form-control kt-select2 erp-form-control-sm listing_studio_join_name" name="listing_studio_join_name">
                                            <option value="0">Select</option>
                                            @php $t_join_name = isset($join_table_name)?$join_table_name:""@endphp
                                            @foreach($data['table_list'] as $table_list)
                                                <option value="{{strtolower($table_list->table_name)}}" {{ ( strtolower($table_list->table_name) == $t_join_name )?"selected":"" }}>{{strtolower($table_list->table_name)}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    ...
                                    <div class="form-group erp-select2 report-select2 join_table_column_name">
                                        @php
                                            if($case == 'edit'){
                                                $j_allCols = \App\Models\ViewAllColumnData::where('table_name', strtoupper($t_join_name))->get();
                                            }
                                        @endphp
                                        <select class="form-control erp-form-control-sm listing_studio_join_table_column_name" multiple name="listing_studio_join_table_column_name[]">
                                            @if($case == 'edit')
                                                @php $j_col = []; @endphp
                                                ...
                                                @foreach($j_col as $col_name)
                                                    <option value="{{$col_name}}" {{ (in_array($col_name, $j_col)) ? 'selected' : '' }}>{{$col_name}}</option>
                                                @endforeach
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="erp-select2 report-select2 join_table_column_title">
                                        <select class="form-control erp-form-control-sm listing_studio_join_table_column_title" multiple name="listing_studio_join_table_column_title[]">
                                            @if($case == 'edit')
                                                @php $jt_col = []; @endphp
                                                @foreach($join_data as $dimension)
                                                ...
                                                @foreach($jt_col as $col_name)
                                                    <option value="{{$col_name}}" {{ (in_array($col_name, $jt_col)) ? 'selected' : '' }}>{{$col_name}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
...
@section('customJS')
    ...
    <script>
        ...
        $(".listing_studio_join_table_column_name,.listing_studio_join_table_column_title").on("select2:select", function (e) {
            var id = e.params.data.id;
            var option = $(e.target).children("[value='"+id+"']");
            option.detach();
            $(e.target).append(option).change();
        ...
        function update_ColumnName_OptionsField() {
            ...
            for(var i=0; i< allLiTitlesCN.length; i++){
                optionsCN += '<option value="'+allLiTitlesCN[i]+'" data-select2-id="'+i+'" selected>'+allLiTitlesCN[i]+'<option>';
            }
