...
@section('content')
    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="alert alert-light alert-elevate fade show" role="alert">
                    <table width="100%">
                        <tr>
                            <td width="12%" class="text-center">From Date:</td>
                            <td width="10%"><input readonly type="text" id="grn_production_date" class="form-control erp-form-control-sm c-date-p" value="{{date('d-m-Y')}}" title="{{date('d-m-Y')}}" /></td>
                            <td width="12%" class="text-center">To Date:</td>
                            <td width="10%"><input readonly type="text" id="grn_production_date" class="form-control erp-form-control-sm c-date-p" value="{{date('d-m-Y')}}" title="{{date('d-m-Y')}}" /></td>
                            <td width="12%" class="text-center">Company:</td>
                            <td width="15%">
                                <div class="erp-select2">
                                    <select class="form-control kt-select2 erp-form-control-sm" id="kt_select2_1" name="grn_currency">
                                        <option value="0">Select</option>
                                        <option value="1">Royalsoft</option>
                                    </select>
                                </div>
                            </td>
                    ...
                    <div class="kt-portlet__body">
                        <div class="kt-widget1 kt-widget1--fit">
                            ...
                            <span class="erp-widget__icon">
                                ...
                                <span class="erp-widget__subtitle"> Delivered </span>
                                <span class="erp-widget__desc"> 15 New Paskages </span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="kt-portlet__body">
                        <div class="kt-widget1 kt-widget1--fit">
                            <div class="erp-widget__item">
                                ...
                                <span class="erp-widget__subtitle"> Ordered </span>
                                <span class="erp-widget__desc"> 72 New Items </span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="kt-portlet__body">
                        <div class="kt-widget1 kt-widget1--fit">
                            <div class="erp-widget__item">
                                ...
                                <span class="erp-widget__subtitle"> Reported </span>
                                <span class="erp-widget__desc"> 72 Support Cases </span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="kt-portlet__body">
                        <div class="kt-widget1 kt-widget1--fit">
                            <div class="erp-widget__item">
                                ...
                                <span class="erp-widget__subtitle"> Arrived </span>
                                <span class="erp-widget__desc"> 34 Upgraded Boxes </span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="kt-portlet kt-portlet--height-fluid">
                    <div class="kt-portlet__head erp-kt-portlet-head4">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">
                                Payable and Receivable Balance
                            </h3>
                        </div>
                    </div>
                    <div class="kt-portlet__body">
                        <div class="kt-widget1 kt-widget1--fit">
                            <div class="kt-widget1__item erp-acc-widget__item_head">
                                <div class="kt-widget1__info">
                                    <h3 class="kt-widget1__title fz-20">Payable Balance</h3>
                                </div>
                                <span class="kt-widget1__number kt-font-warning">9000.00 Cr</span>
                            </div>
                            <div class="erp-acc-widget__item">
                                <div class="erp-acc-widget__info">
                                    <span class="erp-acc-widget__desc">Awerage Weekly Profit</span>
                        ...
                        <div class="kt-widget1 kt-widget1--fit">
                            <div class="kt-widget1__item erp-acc-widget__item_head">
                                <div class="kt-widget1__info">
                                    <h3 class="kt-widget1__title fz-20">Receivable Balance</h3>
                                </div>
                                <span class="kt-widget1__number kt-font-warning">7000.00 Cr</span>
                            </div>
                            <div class="erp-acc-widget__item">
                                <div class="erp-acc-widget__info">
                                    <span class="erp-acc-widget__desc">Awerage Weekly Profit</span>
            ...
            <div class="col-lg-12">
                <div class="kt-portlet kt-portlet--height-fluid kt-portlet--mobile ">
                    ...
                    <div class="kt-portlet__body kt-portlet__body--fit">
                        <!--begin: Datatable -->
                        <div class="kt-datatable size" id="kt_datatable_latest_orders"></div>
        ...
        {{--<div class="row">
            <div class="col-lg-6">
                <div class="kt-portlet kt-portlet--height-fluid">
                    <div class="kt-portlet__head erp-kt-portlet-head3">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">
                                Maximum Item Stock Level
                            </h3>
                    ...
                    <div class="kt-portlet__body">
                        <table class="table table-hover">
                            ...
                            <tr class="text-right">
                                ...
                                <th style=" width: 20%;">Diff. Qty</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr class="text-right">
                                <td class="text-left">BEDROCK</td>
                                <td>5</td>
                                <td>8</td>
                                <td>3</td>
                            </tr>
            ...
            <div class="col-lg-6">
                <div class="kt-portlet kt-portlet--height-fluid">
                    <div class="kt-portlet__head erp-kt-portlet-head1">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">
                                Minimum Item Stock Level
                            </h3>
