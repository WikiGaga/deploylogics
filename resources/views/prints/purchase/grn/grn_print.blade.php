    ...
    <div class="col-lg-12">
        <div class="toggle_table_column">
            ...
            <div class="table_column_dropdown">
                @php
                    $headings = ['Sr No','Barcode','Product Name','Qty','Rate','Sale Rate','Sys Qty','M.R.P',
        ...
        <tbody>
            ...
            @if(isset($dtls))
                ...
                <tr>
                    ...
                    <td class="dtl-head alignright">{{number_format($totRate,3)}}</td>
                    <td class="dtl-head alignright">{{number_format($totSale,3)}}</td>
                    <td class="dtl-head alignright border-right"></td>
                    <td class="dtl-head alignright"></td>
