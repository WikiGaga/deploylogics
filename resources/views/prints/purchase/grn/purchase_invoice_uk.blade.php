    ...
    <div class="col-lg-12">
        <div class="toggle_table_column">
            ...
            <div class="table_column_dropdown">
                @php
                    $headings = ['Sr No','PO #','Barcode','Product Name','Last TP','Qty','Rate','Amount'];
                @endphp
...
<table class="tab" valign="top">
    ...
    <td width="25%">
        ...
        <div>
            <span class="heading heading-block alignleft">Discount</span>
            <span class="normal normal-block alignright">{{number_format($totDisc,3)}}</span>
        </div>
        <div>
