    ...
    <div class="col-lg-12">
        <div class="toggle_table_column">
            ...
            <div class="table_column_dropdown">
                @php
                    $headings = ['Sr No','PO #','Barcode','Product Name','PI Qty','Cost Price','Amount'];
                @endphp
...
@section('content')
{{-- Purchase Invoice --}}
<table class="tableData data_listing pi" id="document_table_data">
    <thead>
        <tr>
...
<table class="tab" valign="top">
    ...
    <td width="25%">
        <div>
            ...
            <span class="normal normal-block alignright">{{number_format($totGST,3)}}</span>
        </div>
        <div>
            <span class="heading heading-block alignleft">GST Inclusive Value</span>
            <span class="normal normal-block alignright">{{number_format($totGstIncl,3)}}</span>
        </div>
        <div>
            <span class="heading heading-block alignleft">Discount + Spe Disc</span>
            <span class="normal normal-block alignright">{{number_format($total_discount,3)}}</span>
        </div>
        <div>
            <span class="heading heading-block alignleft">Advance Tax</span>
            <span class="normal normal-block alignright">{{number_format($totFED,3)}}</span>
        </div>
        <div>
            <span class="heading heading-block alignleft">Gross Amount Payable</span>
...
<table class="tab mrgn-top" valign="bottom">
    <tr>
        ...
        <th width="25%" class="heading aligncenter">
            <div style="height: 20px;"></div>
            <div class="hr_div_line">Received By</div>
        </th>
    </tr>
</table>
@endsection
