    ...
    <div class="col-lg-12">
        <div class="toggle_table_column">
            ...
            <div class="table_column_dropdown">
                @php
                    $headings = ['Sr No','Barcode','Product Name','Sale Rate',
                    'M.R.P','Qty','Amount','Qty/CTN','CTN','PCS'];
                @endphp
...
<table  class="tableData data_listing" id="document_table_data">
    <thead>
        <tr>
            ...
            <th width="12%" class="dtl-head">Barcode</th>
            <th width="31%" class="dtl-head alignleft">Product Name</th>
            <th width="8%" class="dtl-head">Sale Rate</th>
            <th width="8%" class="dtl-head">M.R.P</th>
            <th width="8%" class="dtl-head">Qty</th>
            <th width="10%" class="dtl-head">Amount</th>  
            <th width="6%" class="dtl-head">Qty/CTN</th>      
            <th width="6%" class="dtl-head">CTN</th>      
            <th width="6%" class="dtl-head">PCS</th>
        </tr>
    </thead>
    <tbody>
        @php
        ...
        @if(isset($dtls))
            ...
            <tr>
                ...
                @foreach ($dtl as $pro)
                    ...
                    $sql = App\Models\TblPurcProductBarcode::where('product_barcode_barcode',$pro->barcode->product_barcode_barcode)->first();
                    ...
                    if($unit_per_ctn > 0)
                    {
                        $convert = @round($pro->tbl_purc_grn_dtl_quantity / $unit_per_ctn,2);
                        $array = explode(".",$convert);
                        $ctn = $array[0];
                        $pcs = $pro->tbl_purc_grn_dtl_quantity - ($array[0] * $unit_per_ctn);
                    }else{
                        $ctn = 0;
                        $pcs = 0;
                    }
                    ...
                    <tr>
                        ...
                        <td class="dtl-contents aligncenter">{{$unit_per_ctn}}</td>
            ...
            <tr>
                ...
                <td class="dtl-head alignright border-right"></td>
                <td class="dtl-head alignright border-right"></td>
                <td class="dtl-head aligncenter border-right"></td>
