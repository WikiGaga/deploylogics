    ...
    <div class="col-lg-12">
        <div class="toggle_table_column">
            ...
            <div class="table_column_dropdown">
                @php
                    $headings = ['Sr No','Barcode','Product Name','Sale Rate','M.R.P','Qty','Amount'];
                @endphp
        ...
        <table class="tableData" style="margin-top: 10px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="dtl-contents alignright" style="font-weight: bold">{{number_format($Invoice_net_amount,0)}}</td>
                </tr>
            </tbody>
        </table>
    </td>
