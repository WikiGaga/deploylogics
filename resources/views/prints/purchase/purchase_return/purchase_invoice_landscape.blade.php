        ...
        <div class="toggle_table_column">
            ...
            <div class="table_column_dropdown">
                @php
                    ...
                    'Disc.(%)','GST.(%)','Tax On','FED.(%)','Spec.Disc(%)','Net Amount','Net TP','Last Tp',
...
<table  class="tableData data_listing" id="document_table_data">
    <thead>
        <tr>
            ...
            <th width="4%" class="dtl-head border-right">GST(%)</th>
            <th width="1%" class="dtl-head"></th>
            <th width="4%" class="dtl-head bl-1">FED(%)</th>
    ...
    <tbody>
        ...
        @endphp
        @if(isset($dtls))
            @foreach($dtls as $d_row)
                @php
                $new_dtls[$d_row->product->group_item->group_item_name_string][] = $d_row;
                @endphp
            @endforeach
            @foreach($new_dtls as $key => $dtl)
                ...
                @foreach ($dtl as $pro)
                    ...
                    $totGrossAmt += $pro->tbl_purc_grn_dtl_amount;
                    ...
                    $saleRate = $pro->tbl_purc_grn_dtl_quantity * $pro->tbl_purc_grn_dtl_sale_rate;
                    ...
                    <tr>
                        ...
                        <td class="dtl-contents alignright">{{number_format($pro->tbl_purc_grn_dtl_amount,3)}}</td>
                        <td class="dtl-contents alignright">{{number_format($pro->tbl_purc_grn_dtl_disc_amount,2)}}({{$pro->tbl_purc_grn_dtl_disc_percent,2}})</td>
                        <td class="dtl-contents alignright border-right">{{number_format($pro->tbl_purc_grn_dtl_vat_amount,2)}} ({{$pro->tbl_purc_grn_dtl_vat_percent,2}})</td>
                        <td class="dtl-contents alignright"><span class="tax_on">{{strtoupper($pro->tbl_purc_grn_dtl_tax_on)}}</span></td>
                        <td class="dtl-contents alignright bl-1">{{number_format($pro->tbl_purc_grn_dtl_fed_amount,2)}} ({{$pro->tbl_purc_grn_dtl_fed_percent,2}})</td>
            ...
            <tr>
                ...
                <td class="dtl-head alignright bl-1"></td>
