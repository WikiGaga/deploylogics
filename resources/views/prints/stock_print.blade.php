    ...
    <table class="tableData data_listing" id="document_table_data" style="margin-top: 10px">
        <thead>
            <tr>
                ...
                @if($type != 'sa' && $type!= 'ass' && $type!= 'dss' && $type!= 'di')
                ...
                @endif
                @if($type== 'ass' || $type== 'dss')
                <th width="10%" class="dtl-head">Packing</th>
                ...
                @endif
                @if($type== 'st')
                    <th width="10%" class="dtl-head">Expiry Date</th>
                @endif
            ...
            @if(isset($dtls))
                @foreach($dtls as $dtl)
                    ...
                    <tr>
                        ...
                        @if($type == 'ass' || $type == 'dss')
                            <td class="dtl-contents aligncenter">{{$dtl->barcode->product_barcode_packing}}</td>
                            <td class="dtl-contents aligncenter">{{$store}}</td>
                            <td class="dtl-contents aligncenter">{{$dtl->stock_dtl_batch_no}}</td>
                            <td class="dtl-contents aligncenter">{{$dtl->stock_dtl_amount}}</td>
                        @endif
                        @if($type == 'st')
                            <td class="dtl-contents aligncenter">{{ $stock_expiry_date == '01-01-1970' ? '' : $stock_expiry_date  }}</td>
                        @endif
