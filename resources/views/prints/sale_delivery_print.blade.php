@php
    ...
    $document_type = $data['current']->sales_delivery_type;
    ...
    $days = $data['current']->sales_delivery_credit_days;
    $mobile = $data['current']->sales_delivery_mobile_no;
    $notes = $data['current']->sales_delivery_remarks;
    $NetTotal = $data['current']->sales_delivery_net_amount;
                    ...
                    @endphp
                        @if(isset($dtls))
                            @foreach($dtls as $data)
                               ...
                               // dd($data);
                                    $i++;
                                    $totGrossAmt += $data->sales_delivery_dtl_total_amount;
                                @endphp
                                <tr>
                                    <td class="dtl-contents aligncenter">{{ $loop->iteration }}</td>
                                    <td class="dtl-contents alignleft">{{$data->barcode->product_barcode_barcode}}</td>
                                    ...
                                    <td class="dtl-contents aligncenter">{{$data->sales_delivery_dtl_quantity}}</td>
                                    <td class="dtl-contents alignright">{{number_format($data->sales_delivery_dtl_rate,3)}}</td>
                                    <td class="dtl-contents alignright">{{number_format($data->sales_delivery_dtl_amount,3)}}</td>
                                    <td class="dtl-contents alignright">{{number_format($data->sales_delivery_dtl_disc_amount,3)}}</td>
                                    <td class="dtl-contents alignright">{{number_format($data->sales_delivery_dtl_vat_amount,3)}}</td>
                                    <td class="dtl-contents alignright">{{number_format($data->sales_delivery_dtl_total_amount,3)}}</td>
                                </tr>
                            @endforeach
                        @endif
                        @if($i<=8)
                ...
                <table>
                    <tr>
                        <td class="normal-bold">
                            {{\App\Library\Utilities::AmountWords($NetTotal)}} Only
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table class="tab">
                    <tr>
                        ...
                        <td width="30%">
                            <table class="tab">
                                <tr>
                                    <td width="60%" class="heading alignleft">Sub Total</td>
