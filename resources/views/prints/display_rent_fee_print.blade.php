...
<table class="tableData" style="margin-top: 10px">
    ...
    <tr>
        ...
        <th width="10%" class="dtl-head">Item Description</th>
        <th width="20%" class="dtl-head alignleft">Area of display</th>
    ...
    @if(isset($dtls))
        @foreach($dtls as $data)
            ...
            <tr>
                ...
                <td class="dtl-contents alignleft">{{$data->area_of_display}}</td>
