                        ...
                        @if(isset($dtls))
                            @foreach($dtls as $data)
                                ...
                                <tr style="width:247px;padding:0px 5px;">
                                    <td style="width:20%;font-size:11px;text-align:left;">{{number_format($data->sales_order_dtl_total_amount,3)}}</td>
                                ...
                                <tr style="width:247px;padding:0px 5px;">
                                    <td colspan="1"></td>
                                    <td style="width:50%;font-size:11px;" colspan="2">{{$data->sales_order_dtl_width}} X {{$data->sales_order_dtl_length}}</td>
                                ...
                                <tr style="width:247px;padding:0px 5px;border-bottom:1px dotted;">
                                    ...
                                    <td style="font-weight: normal;font-size:11px;width:15%">{{number_format($data->sales_order_dtl_vat_amount,3)}}</td>
                                    <td style="font-weight: normal;font-size:11px;width:18%;text-align: center;">{{number_format($data->sales_order_dtl_rate,3)}}</td>
                                    <td style="font-weight: normal;font-size:11px;width:18%;text-align: center;">{{$data->sales_order_dtl_quantity}}</td>
                                    <td style="font-weight: normal;font-size:11px;width:29.5%;text-align: right;">{{$data->sales_order_dtl_barcode}}</td>
                                </tr>
                            @endforeach
                        @endif
                    </tbody>
