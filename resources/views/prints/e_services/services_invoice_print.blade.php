                ...
                <table class="tab head">
                    <tr>
                        <td width="30%">
                            <table class="tab">
                                <tr>
                                    <td><img src="/images/{{ auth()->user()->business->business_profile }}" width="110px" height="90px" /></td>
                                </tr>
                            </table>
                        </td>
                        <td width="25%"></td>
                ...
                <table  class="tabData" >
                    <thead>
                        <tr>
                            ...
                            <th width="5%" class="dtl-head">Length</th>
                            <th width="5%" class="dtl-head">Width</th>
                            ...
                            @foreach($dtls as $data)
                               ...
                               // dd($data);
                                ...
                                <tr>
                                    ...
                                    <td class="dtl-contents alignleft">{{$data->sales_dtl_length}}</td>
                                    <td class="dtl-contents alignleft">{{$data->sales_dtl_width}}</td>
                                    ...
                                    <td class="dtl-contents alignright">{{number_format($data->sales_dtl_disc_amount,3)}}</td>
