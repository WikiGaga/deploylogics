    ...
    <table class="tab">
            ...
            <td>
                <table class="tabData">
                    ...
                    <tr>
                        ...
                        <td class="data alignleft" colspan="3"></td>
                    </tr>
                </table>
            </td>
        </tr>
                ...
                <table  class="tabData" >
                    <thead>
                        <tr>
                            ...
                            <th width="12%" class="dtl-head">Account Code</th>
                            <th width="33%" class="dtl-head alignleft">Account Name</th>
                            {{--<th width="9%" class="dtl-head">Budget</th>--}}
                            <th width="9%" class="dtl-head">Payment Mode</th>
                            <th width="9%" class="dtl-head">Mode No</th>
                            <th width="8%" class="dtl-head">Mode Date</th>
                            @if($type == 'brv')
                                <th width="12%" class="dtl-head">Credit</th>
                            @else
                                <th width="12%" class="dtl-head">Debit</th>
                            @endif
                            {{--<th width="9%" class="dtl-head">FC Debit</th>
                            <th width="9%" class="dtl-head">FC Credit</th>--}}
                        </tr>
                    </thead>
                    <tbody>
                    @php
        ...
        <tr>
            <td>
                <table class="tab">
                    <tr>
                        <td width="64%" class="heading alignleft">Total:</td>
                        <td width="18%" class="heading alignright">{{number_format($totAmount,3)}}</td>
                        {{--<td width="9%" class="heading alignright">{{number_format($totCredit,3)}}</td>
                        <td width="9%" class="heading alignright">{{number_format($totFcDebit,3)}}</td>
                        <td width="9%" class="heading alignright">{{number_format($totFcCredit,3)}}</td>--}}
                    </tr>
                    <tr>
                        <td colspan="5">
        ...
        <tr>
            <td>
                <table class="tab mrgn-top" valign="bottom">
                        <tr>
                            <th class="heading aligncenter"><hr class="sign-line">Prepared By</th>
                            ...
                            <th class="heading aligncenter"><hr class="sign-line">Paid By</th>
                        </tr>
                </table>
            </td>
        </tr>
