    ...
    <table  class="tabData" >
        <thead>
            <tr>
                ...
                <th width="12%" class="dtl-head topHeaderInfo">Account Code</th>
                <th width="33%" class="dtl-head topHeaderInfo alignleft">Account Name</th>
                ...
                <th width="12%" class="dtl-head topHeaderInfo">Debit</th>
                <th width="12%" class="dtl-head topHeaderInfo">Credit</th>
            </tr>
        </thead>
        <tbody>
        @php
