        ...
        <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
            <ul class="kt-menu__nav ">
                ...
                <li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true">
                    ...
                    <a href="/home" class="kt-menu__link"><span class="kt-menu__link-icon">
                        ...
                        </span><span class="kt-menu__link-text">{{ __('message.dashboard') }}</span>
                    </a>
                </li>
                @endpermission
                ...
                @php
                    // menu
                    $data_menus = App\Models\TblSoftMenu::with('submenu')
                                            ->where('menu_id','!=', 0)
                                            ->where('menu_id','!=', 10)
