...
@section('content')
    ...
    <form id="sales_form" class="kt-form" method="post" action="{{ action('Sales\SalesFeeController@store', isset($id)?$id:"") }}">
                                ...
                                <div class="col-lg-6">
                                    <div class="erp_form___block">
                                        <div class="input-group open-modal-group">
                                            ...
                                            <input type="text" id="sales_order_code" value="{{isset($sales_order_code)?$sales_order_code:''}}" data-url="{{action('Common\DataTableController@inlineHelpOpen','saleorderHelp')}}" autocomplete="off" name="sales_order_code" class="open_inline__help form-control erp-form-control-sm moveIndex" placeholder="Enter here">
                                ...
                                <table class="table erp_form__grid erp_form__grid_th_resize table-resizable dtr-inline">
                                    ...
                                    <tr id="erp_form_grid_header_row">
                                        ...
                                        <th scope="col">
                                            ...
                                            <div class="erp_form__grid_th_input">
                                                <input id="start_date" value="{{date('d-m-Y')}}" title="{{date('d-m-Y')}}" type="text" class="date_inputmask tb_moveIndex form-control erp-form-control-sm">
                                            </div>
                                        </th>
                                        <th scope="col">
                                            <div class="erp_form__grid_th_title">End Date</div>
                                            <div class="erp_form__grid_th_input">
                                                <input id="end_date" value="{{date('d-m-Y')}}" title="{{date('d-m-Y')}}" type="text" class="date_inputmask tb_moveIndex form-control erp-form-control-sm">
                                            </div>
                                        </th>
                                        <th scope="col">
                                            <div class="erp_form__grid_th_title">Notes</div>
                                            <div class="erp_form__grid_th_input">
                                                <input id="notes" type="text" class="tb_moveIndex form-control erp-form-control-sm">
                                            </div>
                                        </th>
                                        <th scope="col">
                                    ...
                                    @if(isset($dtls))
                                        @foreach($dtls as $dtl)
                                            <tr>
                                                ...
                                                <td><input type="text" name="pd[{{$loop->iteration}}][product_name]" data-id="product_name" value="{{ isset($dtl->product->product_name)?$dtl->product->product_name:$dtl->product_name }}"  title="{{ isset($dtl->product->product_name)?$dtl->product->product_name:$dtl->product_name }}" class="product_name form-control erp-form-control-sm" readonly></td>
                                                <td>
                                                ...
                                                @php $start_date= date('d-m-Y', strtotime(trim(str_replace('/','-',$dtl->sales_dtl_start_date)))); @endphp
                                                <td><input type="text" name="pd[{{$loop->iteration}}][start_date]"  data-id="start_date" value="{{($start_date =='01-01-1970')?'':$start_date}}" title="{{($start_date =='01-01-1970')?'':$start_date}}" class="date_inputmask tb_moveIndex form-control form-control-sm" /></td>
                                                @php $end_date= date('d-m-Y', strtotime(trim(str_replace('/','-',$dtl->sales_dtl_end_date)))); @endphp
                                                <td><input type="text" name="pd[{{$loop->iteration}}][end_date]"  data-id="end_date" value="{{($end_date =='01-01-1970')?'':$end_date}}" title="{{($end_date =='01-01-1970')?'':$end_date}}" class="date_inputmask tb_moveIndex form-control form-control-sm" /></td>
                                                <td><input type="text" name="pd[{{$loop->iteration}}][notes]" data-id="notes"  value="{{$dtl->sales_dtl_notes}}" class="tb_moveIndex form-control erp-form-control-sm"></td>
