...
@section('content')
    ...
    @php
        ...
        if($case == 'edit'){
            $id = $data['current']->protection_id;
            $code = $data['current']->protection_code;
            $date = date('d-m-Y', strtotime(trim(str_replace('/','-',$data['current']->protection_date))));
            $credit_days = $data['current']->protection_credit_days;
            ...
            $delivery_id = $data['current']->protection_delivery_id;
            $type = $data['current']->protection_sales_type;
            $user_id = $data['current']->protection_sales_man;
            $payment_mode = $data['current']->payment_mode_id;
            $exchange_rate = $data['current']->protection_exchange_rate;
            $mobile = $data['current']->protection_mobile_no;
            $address = $data['current']->protection_address;
            $remarks = $data['current']->protection_remarks;
            ...
            $selected_rate_type = $data['current']->protection_rate_type;
            $rate_perc = $data['current']->protection_rate_perc;
    ...
    <form id="protection_form" class="master_form kt-form" method="post" action="{{ action('Sales\ConsumerProtectionController@store', isset($id)?$id:"") }}">
    @csrf
    <input type="hidden" value='consumer_protection' id="form_type" name="form_type">
                ...
                <div class="kt-portlet__body">
                    <div class="row form-group-block">
                        <div class="col-lg-4">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="erp-page--title erp-header-sticky">
                                        {{isset($code)?$code:""}}
                                    </div>
                                </div>
                            </div>
                                        ...
                                        @if(isset($dtls))
                                            @foreach($dtls as $dtl)
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="pd[{{$loop->iteration}}][quantity]" data-id="quantity"  value="{{$dtl->protection_dtl_quantity}}" class="tblGridCal_qty tb_moveIndex form-control erp-form-control-sm validNumber validOnlyFloatNumber" ></td>
                                                    <td><input type="text" name="pd[{{$loop->iteration}}][foc_qty]" data-id="foc_qty"  value="{{$dtl->protection_dtl_foc_qty}}" class="tb_moveIndex form-control erp-form-control-sm validNumber"></td>
                                                    <td><input type="text" name="pd[{{$loop->iteration}}][fc_rate]" data-id="fc_rate"  value="{{number_format($dtl->protection_dtl_fc_rate,3)}}" class="fc_rate tb_moveIndex form-control erp-form-control-sm validNumber"></td>
                                                    <td><input readonly type="text" name="pd[{{$loop->iteration}}][g_rate]" data-id="g_rate"  value="{{number_format($dtl->protection_dtl_gross_rate,3)}}" class="g_rate form-control erp-form-control-sm validNumber" ></td>
                                                    <td><input type="text" name="pd[{{$loop->iteration}}][rate]" data-id="rate"  value="{{number_format($dtl->protection_dtl_rate,3)}}" class="tblGridCal_rate tb_moveIndex form-control erp-form-control-sm validNumber" ></td>
                                                    <td><input type="text" name="pd[{{$loop->iteration}}][amount]" data-id="amount"  value="{{number_format($dtl->protection_dtl_amount,3)}}" class="tblGridCal_amount form-control erp-form-control-sm validNumber" readonly></td>
                                                    <td><input type="text" name="pd[{{$loop->iteration}}][dis_perc]" data-id="dis_perc"  value="{{number_format($dtl->protection_dtl_disc_per,2)}}" class="tblGridCal_discount_perc tb_moveIndex form-control erp-form-control-sm validNumber validOnlyFloatNumber" ></td>
                                                    <td><input type="text" name="pd[{{$loop->iteration}}][dis_amount]" data-id="dis_amount"  value="{{number_format($dtl->protection_dtl_disc_amount,3)}}" class="tblGridCal_discount_amount tb_moveIndex form-control erp-form-control-sm validNumber validOnlyFloatNumber"></td>
                                                    <td><input type="text" name="pd[{{$loop->iteration}}][vat_perc]" data-id="vat_perc"  value="{{number_format($dtl->protection_dtl_vat_per,2)}}" class="tblGridCal_vat_perc tb_moveIndex form-control erp-form-control-sm validNumber validOnlyFloatNumber" ></td>
                                                    <td><input type="text" name="pd[{{$loop->iteration}}][vat_amount]" data-id="vat_amount"  value="{{number_format($dtl->protection_dtl_vat_amount,3)}}" class="tblGridCal_vat_amount tb_moveIndex form-control erp-form-control-sm validNumber validOnlyFloatNumber"></td>
                                                    <td><input type="text" name="pd[{{$loop->iteration}}][gross_amount]" data-id="gross_amount"  value="{{number_format($dtl->protection_dtl_total_amount,3)}}" class="tblGridCal_gross_amount form-control erp-form-control-sm validNumber" readonly></td>
                                            ...
                                            <tbody id="repeated_datasm">
                                                @if($length > 0)
                                                    @foreach($data['accounts'] as $expense_accounts)
                                                        @php
                                                            $expense_amount = '';
                                                            $expense =\App\Models\TblSaleConsumerProtectionExpense::where('chart_account_id',$expense_accounts->chart_account_id)->first('protection_expense_amount');
                                                            if($expense != Null){
                                                                $expense_amount = number_format($expense->protection_expense_amount,3);
                                                            }
                                                        @endphp
                                                        <tr>
...
@section('customJS')
    <script src="{{ asset('js/pages/js/consumer-protection.js') }}" type="text/javascript"></script>
    <script src="{{ asset('js/pages/js/table-calculations-new.js') }}" type="text/javascript"></script>
    <script src="{{ asset('js/jquery-ui.js') }}"></script>
    <script>
        var formcase = 'consumer_protection';
