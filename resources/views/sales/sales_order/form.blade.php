                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="erp-select2">
                                    <select class="form-control erp-form-control-sm kt-select2 moveIndex" id="payment_mode_id" name="payment_mode_id">
                                        <option value="0">Select</option>
                                    </select>
                                </div>
                            </div>
                                ...
                                @if(isset($dtls))
                                    @foreach($dtls as $dtl)
                                        <tr>
                                            ...
                                            <td><input type="text" name="pd[{{$loop->iteration}}][rate]" data-id="rate" value="{{number_format($dtl->sales_order_dtl_rate,2)}}" class="tblGridCal_rate tb_moveIndex form-control erp-form-control-sm validNumber" ></td>
