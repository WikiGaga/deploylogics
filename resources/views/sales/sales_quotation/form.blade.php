...
@section('content')
    ...
    @php
        ...
        $form_type = 'sales_quotation';
    @endphp
    @permission($data['permission'])
    <form id="sales_quotation_form" class="kt-form" method="post" action="{{ action('Sales\SalesQuotationController@store', isset($id)?$id:"") }}">
...
@section('customJS')
    <script src="{{ asset('js/pages/js/sale/sales_quotation.js') }}" type="text/javascript"></script>
