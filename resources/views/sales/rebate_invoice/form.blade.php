...
@section('content')
    ...
    @php
        ...
        $form_type = 'rebate_invoice';
        //dd($data['current']->toArray());
    @endphp
    @permission($data['permission'])
    <form id="sales_form" class="kt-form" method="post" action="{{ action('Sales\RebateInvoiceController@store', isset($id)?$id:"") }}">
                            ...
                            <div class="table-scroll form_input__block">
                                <table class="table erp_form__grid erp_form__grid_th_resize table-resizable dtr-inline">
                                    ...
                                    <tr id="erp_form_grid_header_row">
                                        ...
                                        <th scope="col">
                                            <div class="erp_form__grid_th_title">Purc Amount</div>
                                            <div class="erp_form__grid_th_input">
                                                <input id="purc_amount" type="text" class="purc_amount validNumber validOnlyNumber tb_moveIndex form-control erp-form-control-sm">
                                            </div>
                                        </th>
                                        <th scope="col">
                                    ...
                                    @if(isset($dtls))
                                        @foreach($dtls as $dtl)
                                            <tr>
                                                ...
                                                <td><input type="text" name="pd[{{$loop->iteration}}][purc_amount]" data-id="purc_amount"   value="{{number_format($dtl->purc_amount,3,'.','')}}" class="purc_amount form-control erp-form-control-sm validNumber validOnlyFloatNumber" readonly></td>
