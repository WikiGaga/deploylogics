...
@if($data['form_type'] == 'pos-sales-return')
    @section('title', 'POS Sales Return')
@endif
...
@section('content')
    ...
    @endphp
    @if($data['form_type'] == 'pos-sales-return')
        @php $form_type = 'pos_sale_return'; @endphp
        <form id="sale_return_form" class="kt-form" method="post" action="{{ route('pos_sales_return', isset($id)?$id:"") }}">
        <input type="hidden" value='{{$form_type}}' id="form_type" name="form_type">
    @endif
    @if($data['form_type'] == 'sale-return')
        @php $form_type = 'sale_return'; @endphp
        <form id="sale_return_form" class="kt-form" method="post" action="{{ route('sales_return_noauth', isset($id)?$id:"") }}">
        <input type="hidden" value='{{$form_type}}' id="form_type" name="form_type">
    @endif
    @csrf
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <div class="row form-group-block">
                                ...
                                <div class="erp-select2">
                                    <select class="form-control erp-form-control-sm kt-select2 moveIndex" id="sales_sales_man" name="sales_sales_man">
                                        @if($data['form_type'] == 'sale-return')
                                            ...
                                            @endforeach
                                        @endif
                                        @if($data['form_type'] == 'pos-sales-return' && $data['pos_user'] != null)
                                            @php $select_user = isset($user_id)?$user_id:""; @endphp
                                            <option value="{{$data['pos_user']->id}}" {{$data['pos_user']->id == $select_user?"selected":""}}>{{$data['pos_user']->name}}</option>
                                        @endif
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" id="sales_delivery_id" name="sales_delivery_id" value="{{isset($delivery_id)?$delivery_id:''}}" class="form-control erp-form-control-sm AllowNumberDash text-left moveIndex">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row form-group-block">
                    <div class="col-lg-8">
                        <div class="row">
                            <label class="col-lg-3 erp-col-form-label">Rate Type:</label>
                            <div class="col-lg-9">
                                ...
                                @if(isset($dtls))
                                    @foreach($dtls as $dtl)
                                        <tr>
                                            ...
                                            <td><input type="text" name="pd[{{$loop->iteration}}][fc_rate]" data-id="fc_rate"  value="{{number_format($dtl->sales_dtl_fc_rate,2)}}" class="fc_rate tb_moveIndex form-control erp-form-control-sm validNumber"></td>
                                            <td><input type="text" name="pd[{{$loop->iteration}}][rate]" data-id="rate"  value="{{number_format($dtl->sales_dtl_rate,2)}}" class="tblGridCal_rate tb_moveIndex form-control erp-form-control-sm validNumber" ></td>
