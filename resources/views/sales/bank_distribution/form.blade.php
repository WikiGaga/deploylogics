...
@section('title', 'Bank Distribution Entry')
                                                ...
                                                <div class="denomination_table" id="denomination_table">
                                                    <table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline collapsed">
                                                        ...
                                                        <tbody class="repeated_data">
                                                            @php $sr = 0; @endphp
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" class="form-control erp-form-control-sm qty validNumber" maxlength="15" name="day_qty_{{$sr}}">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" class="form-control erp-form-control-sm amt validNumber" maxlength="15" name="day_value_{{$sr}}" readonly>
                                                                    </td>
                                                                </tr>
                                                                @php $sr++; @endphp
                                                            @endforeach
                                                        <tr>
                                                            ...
                                                            <td id="total_Amt" class="text-right font-weight-bold total_Amt"></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
