                                ...
                                if(response['status'] == 'success'){
                                    ...
                                    for(var i=0;i < quotation.length;i++){
                                        ...
                                        tr += '<tr>'+
                                            ...
                                            '</td>'+
                                            '<td>'+
                                                '<input type="text" name="pd['+iteration+'][amount]" data-id="amount" data-url="" value="'+amount+'" title="'+amount+'" class="form-control erp-form-control-sm tblGridCal_amount validNumber" autocomplete="off">'+
                                            '</td>'+
                                            '<td>'+
