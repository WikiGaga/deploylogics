...
@section('content')
    ...
    @endphp
    <form id="sales_form" class="kt-form" method="post" action="{{ action('Sales\SalesInvoiceController@store', isset($id)?$id:"") }}">
    @csrf
    <input type="hidden" value='sale_invoice' id="form_type">
            ...
            <div class="kt-portlet__body">
                    <div class="kt-portlet__body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-group open-modal-group">
                                            ...
                                            <input type="text" value="{{isset($sales_order_code)?$sales_order_code:""}}" title="{{isset($sales_order_code)?$sales_order_code:""}}" id="sales_order_code" data-url="{{action('Common\DataTableController@helpOpen','saleorderHelp')}}" name="sales_order_code" class="form-control erp-form-control-sm open_modal moveIndex OnlyEnterAllow" placeholder="Enter here">
                                            <input type="hidden" value="{{isset($sales_order_id)?$sales_order_id:""}}" id="sales_order_booking_id" name="sales_order_booking_id">
                                            <div class="input-group-append">
                                                <span class="input-group-text btn-open-modal">
                                                   <i class="la la-search"></i>
                                                </span>
                        ...
                        <div class="row form-group-block">
                            <div class="col-lg-4">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" name="sales_mobile_no" maxlength="15" value="{{isset($mobile)?$mobile:''}}" class="form-control erp-form-control-sm AllowNumberDash text-left moveIndex moveIndex2">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group-block" style="overflow: auto;">
                            <table id="salesForm" class="ErpForm table table-striped table-responsive table-bordered table-hover table-checkable no-footer dtr-inline collapsed table-resizable">
                                <thead>
                                <tr>
                                    <th width="3%">Sr No</th>
