        ...
        <table class="table erp_table__summary dtr-inline">
            ...
            <tr>
                ...
                <th scope="col">
                    ...
                    <div class="erp_form__grid_th_input">
                        <input value="{{ isset($purchase_order_overall_discount)?$purchase_order_overall_discount:0.000}}" type="text" id="overall_discount_perc" name="overall_discount_perc" class="overall_discount_perc validNumber validOnlyNumber form-control erp-form-control-sm" >
                    </div>
                </th>
                <th scope="col">
                    <div class="erp_form__grid_th_title">Order Disc Amt</div>
                    <div class="erp_form__grid_th_input">
                        <input value="{{ isset($purchase_order_overall_disc_amount)?$purchase_order_overall_disc_amount:0.000}}" type="text" id="overall_disc_amount" name="overall_disc_amount" class="overall_disc_amount validNumber validOnlyNumber form-control erp-form-control-sm" >
                    </div>
                </th>
                <th scope="col">
...
@section('summary_total_pageJS')
    <script>
        // overall discount
        $(document).on('keyup blur','#overall_disc_amount,#overall_discount_perc',function(e){
        ...
        function getValuesForDisc(arr = {}){
            ...
            console.log(data.summary_net_amount);
        ...
        function funcGetOverallNetAmount(){
            ...
            var overall_net_amount =  parseFloat(summary_net_amount) - parseFloat(overall_disc_amount)
