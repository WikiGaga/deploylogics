                            ...
                            <div class="col-lg-6">
                                <div class="erp_form___block">
                                    <div class="input-group open-modal-group">
                                        ...
                                        <div class="input-group-append">
                                                <span class="input-group-text btn-open-mob-help" id="OpenInlineSupplierHelp">
                                                <i class="la la-search"></i>
                                                </span>
                                        </div>
                                    </div>
                                ...
                                @if(isset($po_details))
                                    @foreach($po_details as $dtl)
                                        <tr>
                                            ...
                                            <td>
                                                <select class="pd_uom form-control erp-form-control-sm" data-id="pd_uom" name="pd[{{$loop->iteration}}][pd_uom]">
                                                    @if(isset($dtl->uom_list) && is_array($dtl->uom_list) && count($dtl->uom_list) > 0)
                                                        @foreach($dtl->uom_list as $unit)
                                                            <option value="{{ $unit->uom_id ?? '' }}" @if($dtl->uom->uom_id == $unit->uom_id) selected @endif>{{ $unit->uom_name ?? "" }}</option>
                                                        @endforeach
                                                    @else
                                            ...
                                            <td><input type="text" data-id="remarks" name="pd[{{$loop->iteration}}][remarks]" value="{{isset($dtl->purchase_order_dtl_remarks)?$dtl->purchase_order_dtl_remarks:""}}" class="form-control erp-form-control-sm tb_moveIndex"></td>
                                            ...
                                            <td><input type="text" name="pd[{{$loop->iteration}}][foc_qty]" data-id="foc_qty"  value="{{$dtl->purchase_order_dtlfoc_quantity}}" class="tb_moveIndex foc_qty form-control erp-form-control-sm validNumber"></td>
                            ...
                            for(var p=0; p < lpos.length; p++ ){
                                ...
                                tr +='<tr>' +
                                    ...
                                    '<td>'+
                                        ...
                                        '</select>'+
                                    '</td>' +
                                    '<td><input type="text" name="pd['+total_length+'][packing]" data-id="packing" value="'+notNull(lpos[p].packing)+'" title="'+notNull(lpos[p].packing)+'" class="pd_packing form-control erp-form-control-sm" readonly></td>' +
                                    '<td><input type="text" name="pd['+total_length+'][remarks]" data-id="notes" value="" title="" class="pd_packing form-control erp-form-control-sm" readonly></td>' +
                                    '<td><input type="text" name="pd['+total_length+'][quantity]" data-id="quantity" value="'+notNull(lpos[p].qty)+'" title="'+notNull(lpos[p].qty)+'" class="tblGridCal_qty moveIndex form-control erp-form-control-sm validNumber validOnlyNumber" ></td>' +
                                    '<td><input type="text" name="pd['+total_length+'][foc_qty]" data-id="foc_qty" value="'+notNull(lpos[p].foc_qty)+'" title="'+notNull(lpos[p].foc_qty)+'" class="foc_qty moveIndex form-control erp-form-control-sm validNumber validOnlyFloatNumber"></td>' +
                                    '<td><input type="text" name="pd['+total_length+'][fc_rate]" data-id="fc_rate" value="" title="" class="fc-rate moveIndex form-control erp-form-control-sm validNumber"></td>' +
                                    '<td><input type="text" name="pd['+total_length+'][rate]" data-id="rate" value="'+notNullEmpty(lpos[p].rate,threeDecimal)+'" title="'+notNullEmpty(lpos[p].rate,threeDecimal)+'" class="tblGridCal_rate moveIndex form-control erp-form-control-sm validNumber" ></td>' +
                                    '<td><input type="text" name="pd['+total_length+'][amount]" data-id="amount" value="'+notNullEmpty(amount,threeDecimal)+'" title="'+notNullEmpty(lpos[p].amount,threeDecimal)+'" class="tblGridCal_amount form-control erp-form-control-sm validNumber" readonly></td>' +
                                    '<td><input type="text" name="pd['+total_length+'][dis_perc]" data-id="dis_perc" value="'+notNullEmpty(lpos[p].disc_perc,threeDecimal)+'" title="'+notNullEmpty(lpos[p].disc_perc,threeDecimal)+'" class="form-control erp-form-control-sm tblGridCal_discount_perc tb_moveIndex validNumber" ></td>' +
                                    '<td><input type="text" name="pd['+total_length+'][dis_amount]" data-id="dis_amount" value="'+notNullEmpty(lpos[p].disc,threeDecimal)+'" title="'+notNullEmpty(lpos[p].disc,threeDecimal)+'" class="form-control erp-form-control-sm tblGridCal_discount_amount tb_moveIndex validNumber" readonly></td>' +
                                    '<td><input type="text" name="pd['+total_length+'][vat_perc]" data-id="vat_perc" value="'+notNullEmpty(lpos[p].vat_perc,threeDecimal)+'" title="'+notNullEmpty(lpos[p].vat_perc,threeDecimal)+'" class="form-control erp-form-control-sm tblGridCal_vat_perc tb_moveIndex validNumber" ></td>' +
                                    '<td><input type="text" name="pd['+total_length+'][vat_amount]" data-id="vat_amount" value="'+notNullEmpty(lpos[p].vat,threeDecimal)+'" title="'+notNullEmpty(lpos[p].vat,threeDecimal)+'" class="form-control erp-form-control-sm tblGridCal_vat_amount validNumber"></td>' +
                                    '<td><input type="text" name="pd['+total_length+'][gross_amount]" data-id="gross_amount" value="'+notNullEmpty(lpos[p].gross_amount,threeDecimal)+'" title="'+notNullEmpty(lpos[p].gross_amount,threeDecimal)+'" class="form-control erp-form-control-sm tblGridCal_gross_amount validNumber" readonly></td>' +
                                    '<td class="text-center"><div class="btn-group btn-group btn-group-sm" role="group"><button type="button" class="btn btn-danger gridBtn delData"><i class="la la-trash"></i></button></div></td>' +
                                    '</tr>';
                            }
                            $('tbody.erp_form__grid_body').append(tr);
