            ...
            @foreach($product_barcode as $key=>$pb)
                ...
                <div data-repeater-item class="kt-margin-b-10 barcode" item-id="1">
                    <div class="form-group-block row">
                        <div class="col-lg-6">
                            <div class="row">
                                <label class="col-lg-4 erp-col-form-label">{{ __('message.product_barcode') }}:<span class="required">* </span></label>
                                <div class="col-lg-8">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="row">
                                        <label class="col-lg-6 erp-col-form-label">{{ __('message.weight_apply') }}:</label>
                                        <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        <label class="col-lg-6 erp-col-form-label">{{ __('message.base_barcode') }}</label>
                                        <div class="col-lg-6">
                                        <span class="kt-switch kt-switch--sm kt-switch--icon">
                                            <label>
                        ...
                        <div class="col-lg-6">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <span class="form-text text-muted">{{ __('message.allowed_file_types') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>{{-- end row--}}
                    <ul class="barcode_nav nav nav-tabs col-lg-12" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active uom_packing" data-toggle="tab" href="#uom_packing{{$product_barcode_id}}" role="tab">{{ __('message.uom_and_packing') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link rate" data-toggle="tab" href="#rate{{$product_barcode_id}}" role="tab">{{ __('message.rate_and_tax') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link inventory_shelf_stock" data-toggle="tab" href="#inventory_shelf_stock{{$product_barcode_id}}" role="tab">{{ __('message.inventory_and_shelf_stock') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link barcode_print" data-toggle="tab" href="#barcode_print_content{{$product_barcode_id}}" role="tab">{{ __('message.barcode_print') }}</a>
                        </li>
                    </ul>
