...
@section('customJS')
    ...
    <script>
        ...
        var arr_text_Field = [
            ...
            {
                'id':'new_tp',
                'fieldClass':'new_tp validNumber validOnlyNumber',
            },{
                'id':'new_sale_rate',
                'fieldClass':'new_sale_rate validNumber validOnlyNumber',
            },{
                'id':'new_gp_perc',
                ...
                'id':'new_mrp',
                'fieldClass':'new_mrp validNumber validOnlyNumber',
            },{
                    ...
                    success : function(response){
                        ...
                        if(response.status == 'success'){
                            if(response.data['str'] !== null){
                                var dtls = response.data['str']['stock_dtls'];
                                if(response.data['str']['supplier']){
                                    $('#supplier_name').val(response.data['str']['supplier']['supplier_name']);
                                    $('#supplier_id').val(response.data['str']['supplier']['supplier_id']);
                                }
                                var tr = '';
                                var total_length = $('tbody.erp_form__grid_body tr').length;
                                for(var p=0; p < dtls.length; p++ ){
                                    total_length++;
                                    var  row = dtls[p];
                                    console.log(row.barcode.purc_rate_first);
                                    tr += '<tr class="new-row">'+
                                        '<td class="handle">'+
                                        '<i class="fa fa-arrows-alt-v handle"></i>'+
                                        '<input type="text" value="'+total_length+'" name="pd['+total_length+'][sr_no]" title="'+total_length+'" class="form-control erp-form-control-sm handle" readonly="" autocomplete="off" aria-invalid="false">'+
                                        ...
                                        '</td>'+
                                        '<td><input readonly data-id="current_tp" name="pd['+total_length+'][current_tp]" value="'+ (!valueEmpty(row.barcode.purc_rate_first.net_tp)?row.barcode.purc_rate_first.net_tp:"") +'" type="text" class="current_tp form-control erp-form-control-sm validNumber validOnlyNumber"></td>'+
                                        '<td><input readonly data-id="last_tp" name="pd['+total_length+'][last_tp]" value="'+ (!valueEmpty(row.barcode.purc_rate_first.last_tp)?row.barcode.purc_rate_first.last_tp:"") +'" type="text" class="last_tp form-control erp-form-control-sm validNumber validOnlyNumber"></td>'+
                                        '<td><input readonly data-id="sale_rate" name="pd['+total_length+'][sale_rate]" value="'+ (!valueEmpty(row.barcode.purc_rate_first.sale_rate)?row.barcode.purc_rate_first.sale_rate:"") +'" type="text" class="sale_rate form-control erp-form-control-sm validNumber validOnlyNumber"></td>'+
                                        '<td><input readonly data-id="gp_perc" name="pd['+total_length+'][gp_perc]" value="'+ (!valueEmpty(row.barcode.purc_rate_first.gp_perc)?row.barcode.purc_rate_first.gp_perc:"") +'" type="text" class="gp_perc form-control erp-form-control-sm validNumber validOnlyNumber"></td>'+
                                        '<td><input readonly data-id="gp_amount" name="pd['+total_length+'][gp_amount]" value="'+ (!valueEmpty(row.barcode.purc_rate_first.gp_amount)?row.barcode.purc_rate_first.gp_amount:"") +'" type="text" class="gp_amount form-control erp-form-control-sm validNumber validOnlyNumber"></td>'+
                                        '<td><input readonly data-id="mrp" name="pd['+total_length+'][mrp]" value="'+ (!valueEmpty(row.barcode.purc_rate_first.mrp)?row.barcode.purc_rate_first.mrp:"") +'" type="text"  class="mrp form-control erp-form-control-sm validNumber validOnlyNumber"></td>'+
                                        '<td><input readonly data-id="whole_sale_rate" name="pd['+total_length+'][whole_sale_rate]" value="" type="text" class="whole_sale_rate form-control erp-form-control-sm validNumber validOnlyNumber"></td>'+
                                        ...
                                        '<td><input data-id="new_sale_rate" name="pd['+total_length+'][new_sale_rate]"  value="'+ (!valueEmpty(row.barcode.purc_rate_first.sale_rate)?row.barcode.purc_rate_first.sale_rate:"") +'" type="text" class="new_sale_rate form-control erp-form-control-sm validNumber validOnlyNumber tb_moveIndex"></td>'+
                                        '<td><input data-id="new_gp_perc" name="pd['+total_length+'][new_gp_perc]" value="'+ (!valueEmpty(row.barcode.purc_rate_first.gp_perc)?row.barcode.purc_rate_first.gp_perc:"") +'" type="text" class="new_gp_perc form-control erp-form-control-sm validNumber validOnlyNumber"></td>'+
                                        '<td><input data-id="new_gp_amount" name="pd['+total_length+'][new_gp_amount]" value="'+ (!valueEmpty(row.barcode.purc_rate_first.gp_amount)?row.barcode.purc_rate_first.gp_amount:"") +'" type="text" class="new_gp_amount form-control erp-form-control-sm validNumber validOnlyNumber"></td>'+
