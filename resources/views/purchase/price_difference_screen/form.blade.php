...
@section('title', 'Price Difference Screen')
...
@section('content')
    ...
    <form id="pds_form" class="kt-form" method="post" action="{{ action('Purchase\PriceDifferenceScreenController@store' , $id) }}">
                            ...
                            <table class="table erp_form__grid erp_form__grid_th_resize table-resizable dtr-inline">
                                ...
                                <tr>
                                    ...
                                    <th scope="col">
                                        ...
                                        <div class="erp_form__grid_th_input">
                                            <input id="production_date" readonly value="{{date('d-m-Y')}}" title="{{date('d-m-Y')}}" type="text" class="c-date-p kt_datepicker_3 form-control erp-form-control-sm">
                                        </div>
                                    </th>
                                    <th scope="col">
                                        <div class="erp_form__grid_th_title">Expiry Date</div>
                                        <div class="erp_form__grid_th_input">
                                            <input id="expiry_date" readonly value="{{date('d-m-Y')}}" title="{{date('d-m-Y')}}" type="text" class="c-date-p kt_datepicker_3 form-control erp-form-control-sm">
                                        </div>
                                    </th>
                                    <th scope="col">
                                ...
                                @if(isset($data['current']->grn_dtl))
                                    @foreach($data['current']->grn_dtl as $dtl)
                                        <tr>
                                            ...
                                            <td><input type="text" name="pd[{{$loop->iteration}}][fc_rate]" data-id="fc_rate"  value="{{number_format($dtl->tbl_purc_grn_dtl_fc_rate,2)}}" class="fc_rate tb_moveIndex form-control erp-form-control-sm validNumber"></td>
                                            <td><input type="text" name="pd[{{$loop->iteration}}][rate]" data-id="rate"  value="{{number_format($dtl->tbl_purc_grn_dtl_rate,2)}}" class="tblGridCal_rate tb_moveIndex form-control erp-form-control-sm validNumber" ></td>
...
@section('customJS')
    <script src="{{ asset('js/pages/js/purchase/price-difference-screen.js') }}" type="text/javascript"></script>
