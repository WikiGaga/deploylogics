        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <div class="row form-group-block">
                    <div class="col-lg-8">
                        <div class="row">
                            <label class="col-lg-3 erp-col-form-label">Purchase Return Refrence:</label>
                            <div class="col-lg-9">
                                <div class="erp_form___block">
                                    <div class="input-group open-modal-group">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text" value="{{isset($retRef_code)?$retRef_code:''}}" data-url="{{action('Common\DataTableController@inlineHelpOpen','prHelp')}}" id="retqty_code" name="retqty_code" class="open_inline__help form-control erp-form-control-sm moveIndex" placeholder="Enter Ref Purchase Return">
                                        <input type="hidden" id="retqty_id" name="retqty_id" value="{{isset($retRef_id)?$retRef_id:''}}"/>
                                        <input type="hidden" id="ref_supplier_id" name="ref_supplier_id" value="{{isset($ref_supplier_id)?$ref_supplier_id:''}}"/>
                                        <div class="input-group-append">
                                                <span class="input-group-text group-input-btn get-lpo-data" id="pucRetGetData">
                                                Go
                                                </span>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="erp-select2">
                                    <select class="form-control kt-select2 erp-form-control-sm moveIndex" id="kt-select2_validate" name="grn_status">
                                        <option value="">Select</option>
                                        <option @if(isset($grn_status) && $grn_status == 'Pending') selected @endif value="Pending">Pending</option>
                                        <option @if(isset($grn_status) && $grn_status == 'Handedover But Not Collected') selected @endif value="Handedover But Not Collected">Handedover But Not Collected</option>
                                        <option @if(isset($grn_status) && $grn_status == 'Handedover') selected @endif value="Handedover">Handedover</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12 text-right">
                        <div class="data_entry_header">
                            ...
                            <div class="dropdown dropdown-inline">
                                ...
                                @php
                                    $headings = ['Sr No','Barcode','Product Name','UOM','Packing','Sup Barcode','Collected Qty','Pending Qty','Returnable Qty',
                                                'FOC Qty','<span class="fc_dynamic_title">'.$currencySymbol.' Rate (FC)</span>','Rate','Amount','Disc%','Disc Amt','VAT%','Vat Amt',
                        ...
                        <div class="table-scroll form_input__block">
                            <table class="table erp_form__grid erp_form__grid_th_resize table-resizable dtr-inline">
                                ...
                                <tr>
                                    ...
                                    <th scope="col">
                                        <div class="erp_form__grid_th_title">Collected Qty</div>
                                        <div class="erp_form__grid_th_input">
                                    ...
                                    <th scope="col">
                                        <div class="erp_form__grid_th_title">Pending Qty</div>
                                        <div class="erp_form__grid_th_input">
                                            <input id="rtrnpending_quantity" readonly type="text" class="rtrnpending_quantity validNumber validOnlyNumber tb_moveIndex form-control erp-form-control-sm">
                                        </div>
                                    </th>
                                    <th scope="col">
                                        <div class="erp_form__grid_th_title">Returnable Qty</div>
                                        <div class="erp_form__grid_th_input">
                                            <input id="returnable_quantity" type="text" class="returnable_quantity validNumber validOnlyNumber tb_moveIndex form-control erp-form-control-sm">
                                        </div>
                                    </th>
                                    <th scope="col">
                                ...
                                @if(isset($data['current']->grn_dtl))
                                    @foreach($data['current']->grn_dtl as $dtl)
                                        <tr>
                                            ...
                                            <td><input type="text" name="pd[{{$loop->iteration}}][rtrnpending_quantity]" readonly data-id="rtrnpending_quantity"  value="{{$dtl->tbl_purc_grn_dtl_retpend_qty}}" class="rtrnpending_quantity tb_moveIndex form-control erp-form-control-sm validNumber validOnlyFloatNumber" ></td>
                                            <td><input type="text" name="pd[{{$loop->iteration}}][returnable_quantity]" data-id="returnable_quantity"  value="{{$dtl->tbl_purc_grn_dtl_returnable_qty}}" class="returnable_quantity tb_moveIndex form-control erp-form-control-sm validNumber validOnlyFloatNumber" ></td>
