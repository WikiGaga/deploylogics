                        ...
                        <div class="form-group-block" style="overflow: auto;">
                            <table id="grnForm" class="ErpForm table table-striped table-responsive table-bordered table-hover table-checkable no-footer dtr-inline collapsed table-resizable">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 68.6667px;">Barcode</th>
                                    ...
                                    @if(isset($data['current']->grn_dtl))
                                        @foreach($data['current']->grn_dtl as $dtl)
                                            <tr>
                                                ...
                                                <td><input type="text" data-id="barcode" name="pd[{{$loop->iteration}}][barcode]" data-url="{{action('Common\DataTableController@inlineHelpOpen','productHelp')}}" title="{{$dtl->barcode->product_barcode_barcode}}" value="{{$dtl->barcode->product_barcode_barcode}}" class="form-control erp-form-control-sm" readonly></td>
                        ...
                        <div class="row form-group-block">
                            <div class="col-lg-5">
                                <div class="row">
                                    ...
                                    <div class="col-lg-10">
                                        <textarea type="text" rows="4" id="grn_notes" name="grn_notes" maxlength="255" class="moveIndex form-control erp-form-control-sm">{{isset($data['current']->grn_remarks)?$data['current']->grn_remarks:""}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-7">
...
@section('customJS')
    ...
    <script>
        var hiddenFieldsFormName = 'purhaseReturnForm';
        var formcase = '{{$case}}';
