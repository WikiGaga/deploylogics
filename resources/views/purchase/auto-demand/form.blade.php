...
@section('content')
    ...
    @php
        ...
        if($case == 'edit'){
            ...
            $remarks = $data['current']->demand_notes;
    ...
    <form id="stock_item_form" class="stock_form kt-form" method="post"
          action="{{ action('Purchase\AutoDemandController@store' , isset($id)?$id:'') }}">
        @csrf
            ...
            <div class="kt-portlet kt-portlet--mobile">
                ...
                <div class="kt-portlet__body">
                    ...
                    <div class="row form-group-block">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <div class="input-group date">
                                        <input type="text" name="demand_date"
                        ...
                        <div class="col-lg-5">
                            <div class="row">
                                <label class="col-lg-4 erp-col-form-label text-center">Category:</label>
                                <div class="col-lg-8">
                                    <div class="erp-select2">
                                        <select class="moveIndex form-control erp-form-control-sm kt-select2"
                                                name="category_id" required>
                                            <option value="0">Select</option>
                                            @foreach($data['categories'] as $category)
                                                <option value="{{$category->group_item_id}}"
                                                    {{ isset($category_id) && $category->group_item_id == $category_id?'selected':'' }}
                                                >{{$category->group_item_name_string}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="row form-group-block">
                        ...
                        <div class="col-lg-10">
                            <textarea type="text" rows="2" name="demand_notes"
