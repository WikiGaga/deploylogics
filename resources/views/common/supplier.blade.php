...
<div class="modal-body">
    ...
    <!--end: Search Form -->
    <table class="kt-datatable data_table" id="supplier_datatable" width="100%">
        <thead>
        <tr>
            <th>Id</th>
            <th>Code</th>
...
<script>
    $('#supplier_datatable').on('click', 'tbody>tr', function (e) {
        $('#supplier_id').val($(this).find('td:eq(0)').text());
        $('#supplier_code').val($(this).find('td:eq(1)').text());
        $('#supplier_name').val($(this).find('td:eq(2)').text());
