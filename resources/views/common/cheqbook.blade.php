...
<div class="modal-body">
    ...
    <table class="kt-datatable data_table" id="account_datatable" width="100%">
        <thead>
        <tr>
            <th>Cheq No</th>
            <th>Cheq Book Name</th>
        </tr>
        </thead>
        <tbody>
        @foreach ($data as $account)
        <tr>
            <td>{{$account->cheque_book_no_of_cheque}}</td>
            <td>{{$account->cheque_book_name}}</td>
        </tr>
        @endforeach
        </tbody>
    </table>
