    ...
    @permission($view)
        ...
        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid backgroud_img">
                ...
                <div class="kt-portlet__body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            @permission($create)
                                <a href="{{ $data['create-form'] }}" id="btn-create"
                                    class="btn-create btn btn-success btn-elevate btn-sm btn-icon-sm mr-4">
                                    <i class="la la-plus"></i>
                                </a>
                            @endpermission
                            <button type="button"
                                data-url="{{ action('Common\ListingController@openListingUserFilterModal', $data['case']) }}"
                                class="btn btn-bold btn-label-brand btn-sm" data-toggle="modal" id="listing_user_filter"
                                ...
                                <ul class="dropdown-menu dropdown-menu-right checkbox-menu allow-focus listing_dropdown"
                                    ...
                                    <li>
                                        <a href="javascript:void(0);" id="export_csv" class="export-option">
                                            <img src="{{ asset('assets/images/excel.svg') }}" alt="CSV"
                                                style="width: 16px; height: 16px;" class="mr-2"> CSV
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);" id="export_pdf" class="export-option">
                                            <img src="{{ asset('assets/images/pdf.svg') }}" alt="CSV"
                                                style="width: 16px; height: 16px;" class="mr-2"> PDF
                                        </a>
                                    </li>
                                    <li>
                                        <button type="button"
                                            data-url="{{ action('Common\ListingController@openListingDownloads', $data['case']) }}"
                                            class="btn btn-default btn-sm" data-toggle="modal" id="listing_user_downloads"
                                            data-target="#kt_modal_1">
                                            View Downloads
                                        </button>
                                    </li>
            ...
            <div class="kt-portlet__body kt-portlet__body--fit">
                ...
                <div class="kt-datatable ajax_data_table listing_data_table" style="height:100%"
                    data-url="{{ $data['data_url'] }}" id="dynamic_ajax_data"></div>
                <!--end: Datatable -->

                @if (in_array($data['case'], ['purchase-order', 'grn', 'purchase-return', 'pv']))
                    <div style="background: #50cd89;padding: 0 10px;color: #fff;font-weight: 400;font-size: 18px;"> Total
                        Amount: <span class="grn_total_amount">0</span></div>
                @endif
            </div>
