                            ...
                            <div class="row form-group-block">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-group date">
                                                <input type="text" name="issue_date" class="kt_datepicker issue_date form-control erp-form-control-sm c-date-p" readonly/>
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-group date">
                                                <input type="text" name="expiry_date" class="kt_datepicker expiry_date form-control erp-form-control-sm c-date-p" readonly/>
                                                <div class="input-group-append">
                                                    <span class="input-group-text">
                                                        <i class="la la-calendar"></i>
                                                    </span>
...
<script>
        ...
        var kt_repeater_allowance = function() {
            $('#kt_repeater_6').repeater({
                ...
                show: function() {
                    ...
                    $(this).find('.dropzone').html('<div class="dz-default dz-message"><span>Drop files here to upload</span></div>');
                    $(this).slideDown();
                },
                ...
                if(db_dropzone_imgs.length != 0){
                    db_dropzone_imgs.forEach(function(item,index){
                        if(item[0] == count){
                           ...
                           // cd($('.dropzone').find('.kt_dropzone .dz-image-preview:last-child').append('<p>sefe</p>'));
                        }
                    });
                    count++;
                }
    ...
    $('#submit_document').click(function (e) {
        ...
        if(validate == 1){
            ...
            toastr.error('Please upload at least one image with each document.');
        }else{
